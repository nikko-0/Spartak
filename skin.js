...
function pano2vrSkin(player,base) {
	...
	this.addSkin=function() {
		...
		hs='data:image/svg+xml;base64,';
		...
		hs='data:image/svg+xml;base64,'+
		...
		elo.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
		...
		el=me._sp_logo=document.createElement('div');
		els=me._sp_logo__img=document.createElement('img');
		els.className='ggskin ggskin_sp_logo';
		hs=basePath + 'images/sp_logo.png';
		...
		el.setAttribute('style',hs);
		el.style.transformOrigin='50% 50%';
		me._sp_logo.ggIsActive=function() {
			return false;
		}
		el.ggElementNodeId=function() {
			return player.getCurrentNode();
		}
		me._sp_logo.ggUpdatePosition=function (useTransition) {
		}
		me.divSkin.appendChild(me._sp_logo);
		me._screen_tint.logicBlock_visible();
		me.elementMouseOver['screen_tint_close']=false;
		me._screentint_phone.logicBlock_visible();
		me.elementMouseOver['btn_close_popup_phone']=false;
	...
	function SkinCloner_node_cloner_phone_Class(nodeId, parentScope, ggParent, parameter) {
		...
		els.loading = 'lazy';
		if (nodeId) els.setAttribute('src',basePath + "images/thumbnail_image_phone_" + nodeId + ".jpg");
		el.ggNodeId=nodeId;
		hs ='';
		hs += 'position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;;';
		els.setAttribute('style', hs);
	...
	function SkinHotspotClass_ht_info(parentScope,hotspot) {
		...
		elo.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
			''+
			''+
			''+
			'9rZS1saW5lam9pbj0icm91bmQiLz4KPC9zdmc+Cg==';
