...
// Generated 2026-08-13T13:24:35Z
...
function pano2vrSkin(player,base) {
	...
	this.addSkin=function() {
		...
		me._video_popup_vimeo.ggInitMedia = function(media) {
			...
			me._video_popup_vimeo__vid.setAttribute('allow', 'accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share');
			me._video_popup_vimeo__vid.setAttribute('referrerpolicy', 'strict-origin-when-cross-origin');
		...
		me._video_popup_youtube.ggInitMedia = function(media) {
			...
			me._video_popup_youtube__vid.setAttribute('allow', 'accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share');
			me._video_popup_youtube__vid.setAttribute('referrerpolicy', 'strict-origin-when-cross-origin');
...
pano.on("modelloaded", () => { pano.setVariableValue("model_loading", false); });
		...
		player.addListener('changenode', function(event) {
			if (hotspotTemplates.hasOwnProperty('SkinHotspotClass_ht_info')) {
				for(var i = 0; i < hotspotTemplates['SkinHotspotClass_ht_info'].length; i++) {
					hotspotTemplates['SkinHotspotClass_ht_info'][i].ggEvent_changenode();
				}
			}
			if (hotspotTemplates.hasOwnProperty('SkinHotspotClass_ht_node')) {
				for(var i = 0; i < hotspotTemplates['SkinHotspotClass_ht_node'].length; i++) {
		...
		player.addListener('configloaded', function(event) {
			if (hotspotTemplates.hasOwnProperty('SkinHotspotClass_ht_info')) {
				for(var i = 0; i < hotspotTemplates['SkinHotspotClass_ht_info'].length; i++) {
					hotspotTemplates['SkinHotspotClass_ht_info'][i].ggEvent_configloaded();
				}
			}
			if (hotspotTemplates.hasOwnProperty('SkinHotspotClass_ht_node')) {
				for(var i = 0; i < hotspotTemplates['SkinHotspotClass_ht_node'].length; i++) {
		...
		player.addListener('varchanged_open_info_hotspots', function(event) {
			if (hotspotTemplates.hasOwnProperty('SkinHotspotClass_ht_info')) {
				for(var i = 0; i < hotspotTemplates['SkinHotspotClass_ht_info'].length; i++) {
					hotspotTemplates['SkinHotspotClass_ht_info'][i].ggEvent_varchanged_open_info_hotspots();
				}
			}
			if (hotspotTemplates.hasOwnProperty('SkinHotspotClass_ht_info__3d')) {
				for(var i = 0; i < hotspotTemplates['SkinHotspotClass_ht_info__3d'].length; i++) {
					hotspotTemplates['SkinHotspotClass_ht_info__3d'][i].ggEvent_varchanged_open_info_hotspots();
				}
			}
		});
		...
		player.addListener('varchanged_resp_phone', function(event) {
			if (hotspotTemplates.hasOwnProperty('SkinHotspotClass_ht_info')) {
				for(var i = 0; i < hotspotTemplates['SkinHotspotClass_ht_info'].length; i++) {
					hotspotTemplates['SkinHotspotClass_ht_info'][i].ggEvent_varchanged_resp_phone();
				}
			}
			if (hotspotTemplates.hasOwnProperty('SkinHotspotClass_ht_info__3d')) {
				for(var i = 0; i < hotspotTemplates['SkinHotspotClass_ht_info__3d'].length; i++) {
					hotspotTemplates['SkinHotspotClass_ht_info__3d'][i].ggEvent_varchanged_resp_phone();
				}
			}
			me._node_title_phone.logicBlock_visible();
			me._project_title_phone.logicBlock_visible();
		...
		player.addListener('varchanged_vis_hotspots', function(event) {
			if (hotspotTemplates.hasOwnProperty('SkinHotspotClass_ht_info')) {
				for(var i = 0; i < hotspotTemplates['SkinHotspotClass_ht_info'].length; i++) {
					hotspotTemplates['SkinHotspotClass_ht_info'][i].ggEvent_varchanged_vis_hotspots();
				}
			}
			if (hotspotTemplates.hasOwnProperty('SkinHotspotClass_ht_node')) {
				for(var i = 0; i < hotspotTemplates['SkinHotspotClass_ht_node'].length; i++) {
			...
			if (hotspotTemplates.hasOwnProperty('SkinHotspotClass_ht_info__3d')) {
				for(var i = 0; i < hotspotTemplates['SkinHotspotClass_ht_info__3d'].length; i++) {
					hotspotTemplates['SkinHotspotClass_ht_info__3d'][i].ggEvent_varchanged_vis_hotspots();
				}
			}
			if (hotspotTemplates.hasOwnProperty('SkinHotspotClass_ht_node__3d')) {
				for(var i = 0; i < hotspotTemplates['SkinHotspotClass_ht_node__3d'].length; i++) {
		...
		player.addListener('varchanged_vis_skin', function(event) {
			if (hotspotTemplates.hasOwnProperty('SkinHotspotClass_ht_info')) {
				for(var i = 0; i < hotspotTemplates['SkinHotspotClass_ht_info'].length; i++) {
					hotspotTemplates['SkinHotspotClass_ht_info'][i].ggEvent_varchanged_vis_skin();
				}
			}
			if (hotspotTemplates.hasOwnProperty('SkinHotspotClass_ht_node')) {
				for(var i = 0; i < hotspotTemplates['SkinHotspotClass_ht_node'].length; i++) {
			...
			if (hotspotTemplates.hasOwnProperty('SkinHotspotClass_ht_info__3d')) {
				for(var i = 0; i < hotspotTemplates['SkinHotspotClass_ht_info__3d'].length; i++) {
					hotspotTemplates['SkinHotspotClass_ht_info__3d'][i].ggEvent_varchanged_vis_skin();
				}
			}
			if (hotspotTemplates.hasOwnProperty('SkinHotspotClass_ht_node__3d')) {
				for(var i = 0; i < hotspotTemplates['SkinHotspotClass_ht_node__3d'].length; i++) {
	...
	function SkinHotspotClass_ht_url__3d(parentScope,hotspot) {
		...
		let borderRadiusTL = me._ht_url_tooltip.userData.borderRadiusInnerShape.topLeft / 100.0;
		let borderRadiusTR = me._ht_url_tooltip.userData.borderRadiusInnerShape.topRight / 100.0;
		let borderRadiusBR = me._ht_url_tooltip.userData.borderRadiusInnerShape.bottomRight / 100.0;
		let borderRadiusBL = me._ht_url_tooltip.userData.borderRadiusInnerShape.bottomLeft / 100.0;
		...
		me._ht_url_tooltip.userData.backgroundColorAlpha = 1;
		me._ht_url_tooltip.userData.borderColorAlpha = 1;
		me._ht_url_tooltip.userData.setOpacityInternal = function(v) {
		...
		me._ht_url_tooltip.userData.setBackgroundColor = function(v) {
			me._ht_url_tooltip.material.color = v;
		}
		me._ht_url_tooltip.userData.setBackgroundColorAlpha = function(v) {
		...
		var newPos = skin.getElementVrPosition(me._ht_url_tooltip, 0, -30);
		...
		me._ht_url_tooltip.position.y = newPos.y;
			...
			me._ht_url_tooltip.material.needsUpdate = true;
			player.repaint();
		}
		...
		me._ht_url_tooltip.logicBlock_zindex = function() {
			...
			if (me._ht_url_tooltip.ggCurrentLogicStateZIndex != newLogicStateZIndex) {
				...
				if (me._ht_url_tooltip.ggCurrentLogicStateZIndex == 0) {
					me._ht_url_tooltip.userData.zIndexCurrent = 1;
			...
			player.repaint();
					...
					me._ht_url_tooltip.userData.zIndexCurrent = -10000;
			me._ht_url_tooltip.traverse((obj)=>{
				let level = skin.getDepthFrom(me._ht_url_tooltip, obj);
				let treePos = obj.parent ? obj.parent.children.indexOf(obj) : 0;
				if (-10000 > 0) {
		...
		texture = loader.load('data:image/png;base64,'+
	''+
	''+
	''+
	''+
	''+
	''+
	''+
	''+
	''+
	''+
	'JC5NoYcdvqrylcjjVyBQ97rQiD4T83mQ/DMYEjYW/2YP3nJldg+PaB6GCfCEyWv8fxg+HYnJHtu9/y64VH/Pc4U5jCFKbwKPE/bg+HmoGD1w0AAAAASUVORK5CYII=');
		...
		textureOver = loader.load('data:image/png;base64,'+
	''+
	''+
	''+
	''+
	''+
	''+
	''+
	''+
	''+
	''+
	'uefru9V/i6PskcCpMgCMuDGex38lHvsaAReFc96h2KsWfhUWLshwWiREYw53ouOJlrw0TrkJ+miDnXKBbc7r3CisCPm0xGICdwMO0tHIb+uMkFBG4fuAH20cDd8vM4ZgRycwaPb0/wz407/PM4YxjDGMZwJ/H/PitrqegFWecAAAAASUVORK5CYII=');
		...
		me._ht_url_icon.logicBlock_zindex = function() {
			...
			if (me._ht_url_icon.ggCurrentLogicStateZIndex != newLogicStateZIndex) {
				...
				if (me._ht_url_icon.ggCurrentLogicStateZIndex == 0) {
					me._ht_url_icon.userData.zIndexCurrent = 1;
			...
			player.repaint();
					...
					me._ht_url_icon.userData.zIndexCurrent = -10000;
			me._ht_url_icon.traverse((obj)=>{
				let level = skin.getDepthFrom(me._ht_url_icon, obj);
				let treePos = obj.parent ? obj.parent.children.indexOf(obj) : 0;
				if (-10000 > 0) {
	...
	function SkinHotspotClass_ht_url(parentScope,hotspot) {
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
		...
		elo.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
			''+
			''+
			''+
			''+
		...
		if ((hotspot) && (hotspot.customimage)) {
			...
			if (hotspot.customimage && me._ht_url_custom_image.ggText != hotspot.customimage) {
				me._ht_url_custom_image.ggText=me._ht_url_custom_image.ggText_untranslated=hotspot.customimage;
				me._ht_url_custom_image.ggSubElement.setAttribute('src', hotspot.customimage);
				me._ht_url_custom_image.ggSubElement.style.width=hotspot.customimagewidth + 'px';
				me._ht_url_custom_image.ggSubElement.style.height=hotspot.customimageheight + 'px';
				me._ht_url_custom_image.ggUpdatePosition();
			}
		}
		}
		els['ondragstart']=function() { return false; };
	...
	function SkinHotspotClass_ht_node__3d(parentScope,hotspot) {
		...
		me._ht_node_tooltip.userData.backgroundColorAlpha = 1;
		...
		me._ht_node_tooltip.logicBlock_zindex = function() {
			...
			if (me._ht_node_tooltip.ggCurrentLogicStateZIndex != newLogicStateZIndex) {
				...
				if (me._ht_node_tooltip.ggCurrentLogicStateZIndex == 0) {
					me._ht_node_tooltip.userData.zIndexCurrent = 1;
			...
			player.repaint();
					...
					me._ht_node_tooltip.userData.zIndexCurrent = -10000;
			me._ht_node_tooltip.traverse((obj)=>{
				let level = skin.getDepthFrom(me._ht_node_tooltip, obj);
				let treePos = obj.parent ? obj.parent.children.indexOf(obj) : 0;
				if (-10000 > 0) {
		...
		roundedRectShape = new THREE.Shape();
		let borderRadiusTL = me._ht_node_3d.userData.borderRadiusInnerShape.topLeft / 100.0;
		let borderRadiusTR = me._ht_node_3d.userData.borderRadiusInnerShape.topRight / 100.0;
		let borderRadiusBR = me._ht_node_3d.userData.borderRadiusInnerShape.bottomRight / 100.0;
		let borderRadiusBL = me._ht_node_3d.userData.borderRadiusInnerShape.bottomLeft / 100.0;
		roundedRectShape.moveTo((-width / 2.0) + borderRadiusTL, (height / 2.0));
		roundedRectShape.lineTo((width / 2.0) - borderRadiusTR, (height / 2.0));
		if (borderRadiusTR > 0.0) {
		roundedRectShape.arc(0, -borderRadiusTR, borderRadiusTR, Math.PI / 2.0, 2.0 * Math.PI, true);
		...
		me._ht_node_3d.userData.backgroundColorAlpha = 1;
		me._ht_node_3d.userData.borderColorAlpha = 1;
		me._ht_node_3d.userData.setOpacityInternal = function(v) {
		...
		me._ht_node_3d.userData.setBackgroundColor = function(v) {
			me._ht_node_3d.material.color = v;
		}
		me._ht_node_3d.userData.setBackgroundColorAlpha = function(v) {
		...
		me._ht_node_3d.logicBlock_backgroundcolor = function() {
			...
			if (me._ht_node_3d.ggCurrentLogicStateBackgroundColor != newLogicStateBackgroundColor) {
				...
				if (me._ht_node_3d.ggCurrentLogicStateBackgroundColor == 0) {
					me._ht_node_3d.userData.setBackgroundColor(player.getTHREESkinColor('#dfe036'));
					me._ht_node_3d.userData.setBackgroundColorAlpha(1);
					player.repaint();
				}
				else {
					me._ht_node_3d.userData.setBackgroundColor(player.getTHREESkinColor('#ffffff'));
					me._ht_node_3d.userData.setBackgroundColorAlpha(1);
					player.repaint();
				}
			}
		...
		me._ht_node_3d.logicBlock_zindex = function() {
			...
			if (me._ht_node_3d.ggCurrentLogicStateZIndex != newLogicStateZIndex) {
				...
				if (me._ht_node_3d.ggCurrentLogicStateZIndex == 0) {
					me._ht_node_3d.userData.zIndexCurrent = 1;
			...
			player.repaint();
					...
					me._ht_node_3d.userData.zIndexCurrent = -10000;
			me._ht_node_3d.traverse((obj)=>{
				let level = skin.getDepthFrom(me._ht_node_3d, obj);
				let treePos = obj.parent ? obj.parent.children.indexOf(obj) : 0;
				if (-10000 > 0) {
	...
	'T3qNmEbo0+lFwh4LJrzNQw4TJlbOKZynTXCq5jJenFDKBjhDm+eweRHd8d+wH37zJ7wP0Q+Q64/43ZA+6vEOnW7Jg7ZC4GMBl11mISufRk0rjLJzGNX8dsvLmF+Zj7O7iliUQikUgkEolEIlER/gPwCD7wxPugjwAAAABJRU5ErkJggg==');
		...
		el.userData.createGeometry = function(brTopLeft, brTopRight, brBottomRight, brBottomLeft) {
			...
			el.userData.borderRadiusInnerShape.bottomRight = Math.min(brBottomRight, minDim);
			el.userData.borderRadiusInnerShape.bottomLeft = Math.min(brBottomLeft, minDim);
		geometry = new THREE.PlaneGeometry(me._ht_node_3d_icon.userData.width / 100.0, me._ht_node_3d_icon.userData.height / 100.0, 5, 5 );
	...
	function SkinHotspotClass_ht_info__3d(parentScope,hotspot) {
		...
		me._ht_info.logicBlock_visible = function() {
			...
			me._ht_info.visible=((!me._ht_info.material && Number(me._ht_info.userData.opacity>0)) || (me._ht_info.material && Number(me._ht_info.material.opacity)>0))?true:false;
			player.repaint();
		...
		me._ht_info.userData.onmouseenter=function (e) {
			...
			me._ht_info_icon.logicBlock_zindex();
			player.triggerEvent('hsproxyover', {'id': me.hotspot.id, 'url': me.hotspot.url});
		}
		...
		el = new THREE.Mesh();
			material = new THREE.MeshBasicMaterial( { color: player.getTHREESkinColor('#000000'), side : THREE.DoubleSide, transparent : (player.get3dModelType() != 2 || false) } ); 
			el.userData.transparentIn3d = material.transparent;
			material.name = 'ht_info_popup_3d_material';
			el.material = material;
		el.translateX(2.6);
		el.translateY(-1.525);
		el.scale.set(1.00, 1.00, 1.0);
		el.userData.width = 600;
		el.userData.height = 375;
		el.userData.scale = {x: 1.00, y: 1.00, z: 1.0};
		el.userData.curScaleOffX = 0;
		el.userData.curScaleOffY = 0;
		el.userData.borderRadius = {};
		...
		el.userData.renderOrder = 1;
		el.userData.isVisible = function() {
			let vis = me._ht_info_popup_3d.visible
			let parentEl = me._ht_info_popup_3d.parent;
			while (vis && parentEl) {
				if (!parentEl.visible) {
					vis = false;
					break;
		...
		el.userData.setOpacity = function(v) {
			me._ht_info_popup_3d.userData.opacity = v;
			v = v * me._ht_info_popup_3d.userData.parentOpacity;
			if (me._ht_info_popup_3d.userData.setOpacityInternal) me._ht_info_popup_3d.userData.setOpacityInternal(v);
			for (let i = 0; i < me._ht_info_popup_3d.children.length; i++) {
				let child = me._ht_info_popup_3d.children[i];
				if (child.userData.setParentOpacity) {
					child.userData.setParentOpacity(v);
				}
			};
		...
		el.userData.setParentOpacity = function(v) {
			me._ht_info_popup_3d.userData.parentOpacity = v;
			v = v * me._ht_info_popup_3d.userData.opacity
			if (me._ht_info_popup_3d.userData.setOpacityInternal) me._ht_info_popup_3d.userData.setOpacityInternal(v);
			for (let i = 0; i < me._ht_info_popup_3d.children.length; i++) {
				let child = me._ht_info_popup_3d.children[i];
				if (child.userData.setParentOpacity) {
		...
		el.userData.createGeometry = function(bwTop, bwRight, bwBottom, bwLeft, brTopLeft, brTopRight, brBottomRight, brBottomLeft) {
			...
			let width = el.userData.width / 100.0;
			let height = el.userData.height / 100.0;
			skin.rectCalcBorderRadiiInnerShape(me._ht_info_popup_3d);
			if (skin.rectHasRoundedCorners(me._ht_info_popup_3d)) {
		roundedRectShape = new THREE.Shape();
		let borderRadiusTL = me._ht_info_popup_3d.userData.borderRadiusInnerShape.topLeft / 100.0;
		let borderRadiusTR = me._ht_info_popup_3d.userData.borderRadiusInnerShape.topRight / 100.0;
		let borderRadiusBR = me._ht_info_popup_3d.userData.borderRadiusInnerShape.bottomRight / 100.0;
		let borderRadiusBL = me._ht_info_popup_3d.userData.borderRadiusInnerShape.bottomLeft / 100.0;
		roundedRectShape.moveTo((-width / 2.0) + borderRadiusTL, (height / 2.0));
		roundedRectShape.lineTo((width / 2.0) - borderRadiusTR, (height / 2.0));
		if (borderRadiusTR > 0.0) {
		roundedRectShape.arc(0, -borderRadiusTR, borderRadiusTR, Math.PI / 2.0, 2.0 * Math.PI, true);
		...
		geometry = new THREE.ShapeGeometry(roundedRectShape);
		geometry.name = 'ht_info_popup_3d_geometry';
		geometry.computeBoundingBox();
		var min = geometry.boundingBox.min;
		var max = geometry.boundingBox.max;
		var offset = new THREE.Vector2(0 - min.x, 0 - min.y);
		...
		me._ht_info_popup_3d.userData.backgroundColorAlpha = 0.666667;
		me._ht_info_popup_3d.userData.borderColorAlpha = 1;
		me._ht_info_popup_3d.userData.setOpacityInternal = function(v) {
			me._ht_info_popup_3d.material.opacity = v * me._ht_info_popup_3d.userData.backgroundColorAlpha;
			if (me._ht_info_popup_3d.userData.ggSubElement) {
				me._ht_info_popup_3d.userData.ggSubElement.material.opacity = v
				me._ht_info_popup_3d.userData.ggSubElement.visible = (v>0 && me._ht_info_popup_3d.userData.visible);
			}
			me._ht_info_popup_3d.visible = (v>0 && me._ht_info_popup_3d.userData.visible);
		}
		me._ht_info_popup_3d.userData.setBackgroundColor = function(v) {
			me._ht_info_popup_3d.material.color = v;
		}
		me._ht_info_popup_3d.userData.setBackgroundColorAlpha = function(v) {
			me._ht_info_popup_3d.userData.backgroundColorAlpha = v;
			me._ht_info_popup_3d.userData.setOpacity(me._ht_info_popup_3d.userData.opacity);
		}
		el.userData.createGeometry(0, 0, 0, 0, 0, 0, 0, 0);
		el.userData.ggId="ht_info_popup_3d";
		me._ht_info_popup_3d.userData.ggIsActive=function() {
			if ((this.parent) && (this.parent.ggIsActive)) {
				return this.parent.ggIsActive();
			}
			return false;
		...
		me._ht_info_popup_3d.logicBlock_visible = function() {
			var newLogicStateVisible;
			if (
			...
			if (me._ht_info_popup_3d.ggCurrentLogicStateVisible != newLogicStateVisible) {
				me._ht_info_popup_3d.ggCurrentLogicStateVisible = newLogicStateVisible;
				if (me._ht_info_popup_3d.ggCurrentLogicStateVisible == 0) {
			me._ht_info_popup_3d.visible=((!me._ht_info_popup_3d.material && Number(me._ht_info_popup_3d.userData.opacity>0)) || (me._ht_info_popup_3d.material && Number(me._ht_info_popup_3d.material.opacity)>0))?true:false;
			player.repaint();
			me._ht_info_popup_3d.userData.visible=true;
				}
				else {
			me._ht_info_popup_3d.visible=false;
			player.repaint();
			me._ht_info_popup_3d.userData.visible=false;
				}
			}
		}
		me._ht_info_popup_3d.userData.ggUpdatePosition=function (useTransition) {
		}
		el = new THREE.Group();
		el.userData.setOpacityInternal = function(v) {
			me._ht_info_popup_text_3d.visible = (v>0 && me._ht_info_popup_text_3d.userData.visible);
		}
		el.userData.width = 0;
		el.userData.height = 0;
		el.translateX(0);
		el.translateY(-0.15);
		el.scale.set(1.00, 1.00, 1.0);
		el.userData.width = 540;
		el.userData.height = 285;
		el.userData.scale = {x: 1.00, y: 1.00, z: 1.0};
		el.userData.curScaleOffX = 0;
		el.userData.curScaleOffY = 0;
		el.userData.borderRadius = {};
		...
		el.userData.renderOrder = 2;
		el.userData.setOpacityInternal = function(v) {
			if (me._ht_info_popup_text_3d.material) me._ht_info_popup_text_3d.material.opacity = v;
			me._ht_info_popup_text_3d.visible = (v>0 && me._ht_info_popup_text_3d.userData.visible);
		}
		el.userData.isVisible = function() {
			let vis = me._ht_info_popup_text_3d.visible
			let parentEl = me._ht_info_popup_text_3d.parent;
			while (vis && parentEl) {
				if (!parentEl.visible) {
					vis = false;
					break;
		...
		el.userData.setOpacity = function(v) {
			me._ht_info_popup_text_3d.userData.opacity = v;
			v = v * me._ht_info_popup_text_3d.userData.parentOpacity;
			if (me._ht_info_popup_text_3d.userData.setOpacityInternal) me._ht_info_popup_text_3d.userData.setOpacityInternal(v);
			for (let i = 0; i < me._ht_info_popup_text_3d.children.length; i++) {
				let child = me._ht_info_popup_text_3d.children[i];
				if (child.userData.setParentOpacity) {
					child.userData.setParentOpacity(v);
				}
			};
		...
		el.userData.setParentOpacity = function(v) {
			me._ht_info_popup_text_3d.userData.parentOpacity = v;
			v = v * me._ht_info_popup_text_3d.userData.opacity
			if (me._ht_info_popup_text_3d.userData.setOpacityInternal) me._ht_info_popup_text_3d.userData.setOpacityInternal(v);
			for (let i = 0; i < me._ht_info_popup_text_3d.children.length; i++) {
				let child = me._ht_info_popup_text_3d.children[i];
				if (child.userData.setParentOpacity) {
		...
		el.userData.parentOpacity = 1.0;
		el.userData.transitions = [];
		me._ht_info_popup_text_3d = el;
		el.userData.ggId="ht_info_popup_text_3d";
		me._ht_info_popup_text_3d.userData.ggIsActive=function() {
			if ((this.parent) && (this.parent.ggIsActive)) {
				return this.parent.ggIsActive();
			}
			return false;
		...
		me._ht_info_popup_text_3d.userData.ggUpdatePosition=function (useTransition) {
		}
		el = new THREE.Mesh();
			material = new THREE.MeshBasicMaterial( {side : THREE.DoubleSide, transparent : (player.get3dModelType() != 2 || false) } ); 
			el.userData.transparentIn3d = material.transparent;
			material.name = 'ht_info_popup_text_body_3d_material';
			el.material = material;
		el.translateX(0);
		el.translateY(-0.3);
		el.scale.set(1.00, 1.00, 1.0);
		el.userData.width = 540;
		el.userData.height = 225;
		el.userData.scale = {x: 1.00, y: 1.00, z: 1.0};
		el.userData.curScaleOffX = 0;
		el.userData.curScaleOffY = 0;
		el.userData.borderRadius = {};
		...
		el.userData.borderRadius.bottomRight = el.userData.borderRadiusInnerShape.bottomRight = 0;
		el.userData.borderRadius.bottomLeft = el.userData.borderRadiusInnerShape.bottomLeft = 0;
		el.name = 'ht_info_popup_text_body_3d';
		el.userData.x = 0;
		el.userData.y = -0.3;
		el.translateZ(0.090);
		el.userData.zIndex = -10000;
		...
		el.userData.renderOrder = 3;
		el.userData.isVisible = function() {
			let vis = me._ht_info_popup_text_body_3d.visible
			let parentEl = me._ht_info_popup_text_body_3d.parent;
			while (vis && parentEl) {
				if (!parentEl.visible) {
					vis = false;
					break;
		...
		el.userData.setOpacity = function(v) {
			me._ht_info_popup_text_body_3d.userData.opacity = v;
			v = v * me._ht_info_popup_text_body_3d.userData.parentOpacity;
			if (me._ht_info_popup_text_body_3d.userData.setOpacityInternal) me._ht_info_popup_text_body_3d.userData.setOpacityInternal(v);
			for (let i = 0; i < me._ht_info_popup_text_body_3d.children.length; i++) {
				let child = me._ht_info_popup_text_body_3d.children[i];
				if (child.userData.setParentOpacity) {
					child.userData.setParentOpacity(v);
				}
			};
		...
		el.userData.setParentOpacity = function(v) {
			me._ht_info_popup_text_body_3d.userData.parentOpacity = v;
			v = v * me._ht_info_popup_text_body_3d.userData.opacity
			if (me._ht_info_popup_text_body_3d.userData.setOpacityInternal) me._ht_info_popup_text_body_3d.userData.setOpacityInternal(v);
			for (let i = 0; i < me._ht_info_popup_text_body_3d.children.length; i++) {
				let child = me._ht_info_popup_text_body_3d.children[i];
				if (child.userData.setParentOpacity) {
		...
		el.userData.parentOpacity = 1.0;
		el.userData.transitions = [];
		me._ht_info_popup_text_body_3d = el;
		el.userData.borderWidth = {};
		el.userData.borderWidth.default = {};
		el.userData.borderWidth.default.top = 0;
		el.userData.borderWidth.default.right = 0;
		...
		el.userData.borderRadiusInnerShape = {};
		el.userData.createGeometry = function(bwTop, bwRight, bwBottom, bwLeft, brTopLeft, brTopRight, brBottomRight, brBottomLeft) {
			let el = me._ht_info_popup_text_body_3d;
			skin.disposeGeometryAndMaterial(el);
			skin.removeChildren(el, 'subElement');
			if (typeof(bwTop) != 'undefined') {
				el.userData.borderWidth.top = bwTop;
			...
			let width = el.userData.width / 100.0;
			let height = el.userData.height / 100.0;
			skin.rectCalcBorderRadiiInnerShape(me._ht_info_popup_text_body_3d);
			if (skin.rectHasRoundedCorners(me._ht_info_popup_text_body_3d)) {
		roundedRectShape = new THREE.Shape();
		let borderRadiusTL = me._ht_info_popup_text_body_3d.userData.borderRadiusInnerShape.topLeft / 100.0;
		let borderRadiusTR = me._ht_info_popup_text_body_3d.userData.borderRadiusInnerShape.topRight / 100.0;
		let borderRadiusBR = me._ht_info_popup_text_body_3d.userData.borderRadiusInnerShape.bottomRight / 100.0;
		let borderRadiusBL = me._ht_info_popup_text_body_3d.userData.borderRadiusInnerShape.bottomLeft / 100.0;
		roundedRectShape.moveTo((-width / 2.0) + borderRadiusTL, (height / 2.0));
		roundedRectShape.lineTo((width / 2.0) - borderRadiusTR, (height / 2.0));
		if (borderRadiusTR > 0.0) {
		roundedRectShape.arc(0, -borderRadiusTR, borderRadiusTR, Math.PI / 2.0, 2.0 * Math.PI, true);
		...
		geometry = new THREE.ShapeGeometry(roundedRectShape);
		geometry.name = 'ht_info_popup_text_body_3d_geometry';
		geometry.computeBoundingBox();
		var min = geometry.boundingBox.min;
		var max = geometry.boundingBox.max;
		var offset = new THREE.Vector2(0 - min.x, 0 - min.y);
		...
		me._ht_info_popup_text_body_3d.userData.backgroundColorAlpha = 1;
		me._ht_info_popup_text_body_3d.userData.borderColorAlpha = 1;
		me._ht_info_popup_text_body_3d.userData.setOpacityInternal = function(v) {
			me._ht_info_popup_text_body_3d.material.opacity = v;
			if (me._ht_info_popup_text_body_3d.userData.hasScrollbar) {
				me._ht_info_popup_text_body_3d.userData.scrollbar.material.opacity = v;
				me._ht_info_popup_text_body_3d.userData.scrollbarBg.material.opacity = v;
			}
			if (me._ht_info_popup_text_body_3d.userData.ggSubElement) {
				me._ht_info_popup_text_body_3d.userData.ggSubElement.material.opacity = v
				me._ht_info_popup_text_body_3d.userData.ggSubElement.visible = (v>0 && me._ht_info_popup_text_body_3d.userData.visible);
			}
			me._ht_info_popup_text_body_3d.visible = (v>0 && me._ht_info_popup_text_body_3d.userData.visible);
		}
		me._ht_info_popup_text_body_3d.userData.setBackgroundColor = function(v) {
			me._ht_info_popup_text_body_3d.material.color = v;
		}
		me._ht_info_popup_text_body_3d.userData.setBackgroundColorAlpha = function(v) {
			me._ht_info_popup_text_body_3d.userData.backgroundColorAlpha = v;
			me._ht_info_popup_text_body_3d.userData.setOpacity(me._ht_info_popup_text_body_3d.userData.opacity);
		}
		el.userData.createGeometry(0, 0, 0, 0, 0, 0, 0, 0);
		el.userData.backgroundColor = player.getTHREESkinColor('#ffffff');
		el.userData.textColor = '#ffffff';
		el.userData.textColorAlpha = 1;
		el.userData.cssClasses = ['noto_sans'];
		var canvas = document.createElement('canvas');
		canvas.width = 1080;
		canvas.height = 450;
		el.userData.textCanvas = canvas;
		...
		el.userData.tmpCanvasContext = tmpCanvas.getContext('2d');
		el.userData.ggTextureFromCanvas = function() {
			var el = me._ht_info_popup_text_body_3d;
			var canv = me._ht_info_popup_text_body_3d.userData.textCanvas;
			var ctx = me._ht_info_popup_text_body_3d.userData.textCanvasContext;
			var tmpCanv = me._ht_info_popup_text_body_3d.userData.tmpCanvas;
			ctx.clearRect(0, 0, canv.width, canv.height);
			if (tmpCanv.width > 0 && tmpCanv.height > 0) {
				ctx.drawImage(tmpCanv, 0, ( me._ht_info_popup_text_body_3d.userData.scrollPosPercent ? tmpCanv.height * me._ht_info_popup_text_body_3d.userData.scrollPosPercent : 0), canv.width, canv.height, 0, 0, canv.width, canv.height);
			}
			var textTexture = new THREE.CanvasTexture(canv);
			textTexture.name = 'ht_info_popup_text_body_3d_texture';
			textTexture.minFilter = THREE.LinearFilter;
			textTexture.colorSpace = THREE.LinearSRGBColorSpace;
			textTexture.wrapS = THREE.ClampToEdgeWrapping;
			textTexture.wrapT = THREE.ClampToEdgeWrapping;
			if (me._ht_info_popup_text_body_3d.material.map) {
				me._ht_info_popup_text_body_3d.material.map.dispose();
			}
			me._ht_info_popup_text_body_3d.material.map = textTexture;
			me._ht_info_popup_text_body_3d.material.needsUpdate = true;
			player.repaint();
		}
		el.userData.ggRenderText = function() {
			skin.removeChildren(me._ht_info_popup_text_body_3d, 'scrollbar');
			skin.paintTextDivToCanvas(me._ht_info_popup_text_body_3d, 'box-sizing: border-box; width: 540px; height: auto; font-size: 16px; font-weight: 500; color: rgba(255,255,255,1); text-align: left; white-space: pre-line; padding: 0px; overflow: hidden; overflow-y: auto;line-height: 1.4;' + '; color: ' + me._ht_info_popup_text_body_3d.userData.textColor + ' !important;', false, false, true, true);
			if (me._ht_info_popup_text_body_3d.userData.totalHeightCanv > (me._ht_info_popup_text_body_3d.userData.height)) {
				skin.paintTextDivToCanvas(me._ht_info_popup_text_body_3d, 'box-sizing: border-box; width: 520px; height: auto; font-size: 16px; font-weight: 500; color: rgba(255,255,255,1); text-align: left; white-space: pre-line; padding: 0px; overflow: hidden; overflow-y: auto;line-height: 1.4;' + '; color: ' + me._ht_info_popup_text_body_3d.userData.textColor + ' !important;', false, false, true);
			} else {
			skin.paintTextDivToCanvas(me._ht_info_popup_text_body_3d, 'box-sizing: border-box; width: 540px; height: auto; font-size: 16px; font-weight: 500; color: rgba(255,255,255,1); text-align: left; white-space: pre-line; padding: 0px; overflow: hidden; overflow-y: auto;line-height: 1.4;' + '; color: ' + me._ht_info_popup_text_body_3d.userData.textColor + ' !important;', false, false, true);
			}
			me._ht_info_popup_text_body_3d.userData.scrollPosPercent = 0.0
			if (me._ht_info_popup_text_body_3d.userData.totalHeightCanv > ((me._ht_info_popup_text_body_3d.userData.height))) {
				me._ht_info_popup_text_body_3d.userData.pagePercent = ((me._ht_info_popup_text_body_3d.userData.height) - me._ht_info_popup_text_body_3d.userData.lineHeight) / me._ht_info_popup_text_body_3d.userData.totalHeightCanv;
				me._ht_info_popup_text_body_3d.userData.maxScrollPercent = (me._ht_info_popup_text_body_3d.userData.totalHeightCanv - (1 * (me._ht_info_popup_text_body_3d.userData.height))) / me._ht_info_popup_text_body_3d.userData.totalHeightCanv;
				geometry = new THREE.PlaneGeometry(20 / 100.0, me._ht_info_popup_text_body_3d.userData.height / 100.0, 5, 5 );
				geometry.name = 'ht_info_popup_text_body_3d_scrollbarBgGeometry';
				material = new THREE.MeshBasicMaterial( {color: 0x7f7f7f, side: THREE.DoubleSide, transparent: true } );
				material.name = 'ht_info_popup_text_body_3d_scrollbarBgMaterial';
				me._ht_info_popup_text_body_3d.userData.scrollbarBg = new THREE.Mesh( geometry, material );
				me._ht_info_popup_text_body_3d.userData.scrollbarBg.name = 'ht_info_popup_text_body_3d_scrollbarBg';
				me._ht_info_popup_text_body_3d.add(me._ht_info_popup_text_body_3d.userData.scrollbarBg);
				me._ht_info_popup_text_body_3d.userData.scrollbarXPos = (me._ht_info_popup_text_body_3d.userData.width - 20) / 200.0;
				me._ht_info_popup_text_body_3d.userData.scrollbarBg.position.x = me._ht_info_popup_text_body_3d.userData.scrollbarXPos;
				me._ht_info_popup_text_body_3d.userData.scrollbarBg.position.z = me._ht_info_popup_text_body_3d.position.z + 0.01;
				me._ht_info_popup_text_body_3d.userData.scrollbarBg.userData.stopPropagation = true;
				me._ht_info_popup_text_body_3d.userData.scrollbarHeight = ((1 * me._ht_info_popup_text_body_3d.userData.height) / me._ht_info_popup_text_body_3d.userData.totalHeightCanv) * me._ht_info_popup_text_body_3d.userData.height;
				geometry = new THREE.PlaneGeometry(20 / 100.0, me._ht_info_popup_text_body_3d.userData.scrollbarHeight / 100.0, 5, 5 );
				geometry.name = 'ht_info_popup_text_body_3d_scrollbarGeometry';
				material = new THREE.MeshBasicMaterial( {color: 0xbfbfbf, side: THREE.DoubleSide, transparent: true } );
				material.name = 'ht_info_popup_text_body_3d_scrollbarMaterial';
				me._ht_info_popup_text_body_3d.userData.scrollbar = new THREE.Mesh( geometry, material );
				me._ht_info_popup_text_body_3d.userData.scrollbar.name = 'ht_info_popup_text_body_3d_scrollbar';
				me._ht_info_popup_text_body_3d.add(me._ht_info_popup_text_body_3d.userData.scrollbar);
				me._ht_info_popup_text_body_3d.userData.scrollbar.position.x = me._ht_info_popup_text_body_3d.userData.scrollbarXPos;
				me._ht_info_popup_text_body_3d.userData.scrollbar.position.z = me._ht_info_popup_text_body_3d.position.z + 0.02;
				me._ht_info_popup_text_body_3d.userData.scrollbarYPosMin = (me._ht_info_popup_text_body_3d.userData.height - me._ht_info_popup_text_body_3d.userData.scrollbarHeight) / 200.0;
				me._ht_info_popup_text_body_3d.userData.scrollbarYPosMax = me._ht_info_popup_text_body_3d.userData.scrollbarYPosMin - (me._ht_info_popup_text_body_3d.userData.height - me._ht_info_popup_text_body_3d.userData.scrollbarHeight) / 100.0;
				me._ht_info_popup_text_body_3d.userData.scrollbar.position.y = me._ht_info_popup_text_body_3d.userData.scrollbarYPosMin;
				geometry = new THREE.PlaneGeometry(20 / 100.0, me._ht_info_popup_text_body_3d.userData.height / 200.0, 5, 5 );
				geometry.name = 'ht_info_popup_text_body_3d_scrollbarPageDownGeometry';
				material = new THREE.MeshBasicMaterial( {color: 0x000000, side: THREE.DoubleSide, transparent: true } );
				material.name = 'ht_info_popup_text_body_3d_scrollbarPageDownMaterial';
				me._ht_info_popup_text_body_3d.userData.scrollbarPageDown = new THREE.Mesh( geometry, material );
				me._ht_info_popup_text_body_3d.userData.scrollbarPageDown.name = 'ht_info_popup_text_body_3d_scrollbarPageDown';
				me._ht_info_popup_text_body_3d.userData.scrollbarPageDown.userData.onclick = function() {
					me._ht_info_popup_text_body_3d.userData.scrollPosPercent -= me._ht_info_popup_text_body_3d.userData.pagePercent;
					me._ht_info_popup_text_body_3d.userData.scrollPosPercent = Math.max(me._ht_info_popup_text_body_3d.userData.scrollPosPercent, 0);
					me._ht_info_popup_text_body_3d.userData.ggTextureFromCanvas();
					me._ht_info_popup_text_body_3d.userData.scrollbar.position.y += (me._ht_info_popup_text_body_3d.userData.height * me._ht_info_popup_text_body_3d.userData.pagePercent) / 100.0;
					me._ht_info_popup_text_body_3d.userData.scrollbar.position.y = Math.min(me._ht_info_popup_text_body_3d.userData.scrollbar.position.y, me._ht_info_popup_text_body_3d.userData.scrollbarYPosMin);
				}
				me._ht_info_popup_text_body_3d.userData.scrollbarPageDown.position.x = me._ht_info_popup_text_body_3d.userData.scrollbarXPos;
				me._ht_info_popup_text_body_3d.userData.scrollbarPageDown.position.y = me._ht_info_popup_text_body_3d.userData.height / 400.0;
				me._ht_info_popup_text_body_3d.userData.scrollbarPageDown.position.z = me._ht_info_popup_text_body_3d.position.z + 0.05;
				me._ht_info_popup_text_body_3d.userData.scrollbarPageDown.userData.stopPropagation = true;
				me._ht_info_popup_text_body_3d.userData.scrollbarPageDown.userData.clickInvisible = true;
				me._ht_info_popup_text_body_3d.userData.scrollbarPageDown.visible = false;
				me._ht_info_popup_text_body_3d.add(me._ht_info_popup_text_body_3d.userData.scrollbarPageDown);
				geometry = new THREE.PlaneGeometry(20 / 100.0, me._ht_info_popup_text_body_3d.userData.height / 200.0, 5, 5 );
				geometry.name = 'ht_info_popup_text_body_3d_scrollbarPageUpGeometry';
				material = new THREE.MeshBasicMaterial( {color: 0x000000, side: THREE.DoubleSide, transparent: true } );
				material.name = 'ht_info_popup_text_body_3d_scrollbarPageUpMaterial';
				me._ht_info_popup_text_body_3d.userData.scrollbarPageUp = new THREE.Mesh( geometry, material );
				me._ht_info_popup_text_body_3d.userData.scrollbarPageUp.name = 'ht_info_popup_text_body_3d_scrollbarPageUp';
				me._ht_info_popup_text_body_3d.userData.scrollbarPageUp.userData.onclick = function() {
					me._ht_info_popup_text_body_3d.userData.scrollPosPercent += me._ht_info_popup_text_body_3d.userData.pagePercent;
					me._ht_info_popup_text_body_3d.userData.scrollPosPercent = Math.min(me._ht_info_popup_text_body_3d.userData.scrollPosPercent, me._ht_info_popup_text_body_3d.userData.maxScrollPercent);
					me._ht_info_popup_text_body_3d.userData.ggTextureFromCanvas();
					me._ht_info_popup_text_body_3d.userData.scrollbar.position.y -= (me._ht_info_popup_text_body_3d.userData.height * me._ht_info_popup_text_body_3d.userData.pagePercent) / 100.0;
					me._ht_info_popup_text_body_3d.userData.scrollbar.position.y = Math.max(me._ht_info_popup_text_body_3d.userData.scrollbar.position.y, me._ht_info_popup_text_body_3d.userData.scrollbarYPosMax);
				}
				me._ht_info_popup_text_body_3d.userData.scrollbarPageUp.position.x = me._ht_info_popup_text_body_3d.userData.scrollbarXPos;
				me._ht_info_popup_text_body_3d.userData.scrollbarPageUp.position.y = -me._ht_info_popup_text_body_3d.userData.height / 400.0;
				me._ht_info_popup_text_body_3d.userData.scrollbarPageUp.position.z = me._ht_info_popup_text_body_3d.position.z + 0.05;
				me._ht_info_popup_text_body_3d.userData.scrollbarPageUp.userData.stopPropagation = true;
				me._ht_info_popup_text_body_3d.userData.scrollbarPageUp.userData.clickInvisible = true;
				me._ht_info_popup_text_body_3d.userData.scrollbarPageUp.visible = false;
				me._ht_info_popup_text_body_3d.add(me._ht_info_popup_text_body_3d.userData.scrollbarPageUp);
				me._ht_info_popup_text_body_3d.userData.hasScrollbar = true;
			} else {
				me._ht_info_popup_text_body_3d.userData.hasScrollbar = false;
			}
		}
		el.userData.ggUpdateText=function(force) {
			var params = [];
		...
		el.userData.setBackgroundColor = function(v) {
			me._ht_info_popup_text_body_3d.userData.backgroundColor = v;
		}
		el.userData.setBackgroundColorAlpha = function(v) {
			me._ht_info_popup_text_body_3d.userData.backgroundColorAlpha = v;
		}
		el.userData.setTextColor = function(v) {
			me._ht_info_popup_text_body_3d.userData.textColor = '#' + v.getHexString();
		}
		el.userData.setTextColorAlpha = function(v) {
			me._ht_info_popup_text_body_3d.userData.textColorAlpha = v;
		}
		el.userData.ggId="ht_info_popup_text_body_3d";
		me._ht_info_popup_text_body_3d.userData.ggIsActive=function() {
			if ((this.parent) && (this.parent.ggIsActive)) {
				return this.parent.ggIsActive();
			}
			return false;
		...
		me._ht_info_popup_text_body_3d.userData.ggUpdatePosition=function (useTransition) {
				me._ht_info_popup_text_body_3d.userData.ggUpdateText(true);
		}
		me._ht_info_popup_text_3d.add(me._ht_info_popup_text_body_3d);
		el = new THREE.Mesh();
			material = new THREE.MeshBasicMaterial( {side : THREE.DoubleSide, transparent : (player.get3dModelType() != 2 || false) } ); 
			el.userData.transparentIn3d = material.transparent;
			material.name = 'ht_info_popup_text_headline_3d_material';
			el.material = material;
		el.translateX(0);
		el.translateY(1.275);
		el.scale.set(1.00, 1.00, 1.0);
		...
		el.userData.borderRadius.bottomRight = el.userData.borderRadiusInnerShape.bottomRight = 0;
		el.userData.borderRadius.bottomLeft = el.userData.borderRadiusInnerShape.bottomLeft = 0;
		el.name = 'ht_info_popup_text_headline_3d';
		el.userData.x = 0;
		el.userData.y = 1.275;
		el.translateZ(0.120);
		el.userData.zIndex = -10000;
		...
		el.userData.renderOrder = 4;
		el.userData.isVisible = function() {
			let vis = me._ht_info_popup_text_headline_3d.visible
			let parentEl = me._ht_info_popup_text_headline_3d.parent;
			while (vis && parentEl) {
				if (!parentEl.visible) {
					vis = false;
					break;
		...
		el.userData.setOpacity = function(v) {
			me._ht_info_popup_text_headline_3d.userData.opacity = v;
			v = v * me._ht_info_popup_text_headline_3d.userData.parentOpacity;
			if (me._ht_info_popup_text_headline_3d.userData.setOpacityInternal) me._ht_info_popup_text_headline_3d.userData.setOpacityInternal(v);
			for (let i = 0; i < me._ht_info_popup_text_headline_3d.children.length; i++) {
				let child = me._ht_info_popup_text_headline_3d.children[i];
				if (child.userData.setParentOpacity) {
					child.userData.setParentOpacity(v);
				}
			};
		...
		el.userData.setParentOpacity = function(v) {
			me._ht_info_popup_text_headline_3d.userData.parentOpacity = v;
			v = v * me._ht_info_popup_text_headline_3d.userData.opacity
			if (me._ht_info_popup_text_headline_3d.userData.setOpacityInternal) me._ht_info_popup_text_headline_3d.userData.setOpacityInternal(v);
			for (let i = 0; i < me._ht_info_popup_text_headline_3d.children.length; i++) {
				let child = me._ht_info_popup_text_headline_3d.children[i];
				if (child.userData.setParentOpacity) {
		...
		el.userData.parentOpacity = 1.0;
		el.userData.transitions = [];
		me._ht_info_popup_text_headline_3d = el;
		el.userData.borderWidth = {};
		el.userData.borderWidth.default = {};
		el.userData.borderWidth.default.top = 0;
		el.userData.borderWidth.default.right = 0;
		...
		el.userData.borderRadiusInnerShape = {};
		el.userData.createGeometry = function(bwTop, bwRight, bwBottom, bwLeft, brTopLeft, brTopRight, brBottomRight, brBottomLeft) {
			let el = me._ht_info_popup_text_headline_3d;
			skin.disposeGeometryAndMaterial(el);
			skin.removeChildren(el, 'subElement');
			if (typeof(bwTop) != 'undefined') {
				el.userData.borderWidth.top = bwTop;
			...
			let width = el.userData.width / 100.0;
			let height = el.userData.height / 100.0;
			skin.rectCalcBorderRadiiInnerShape(me._ht_info_popup_text_headline_3d);
			if (skin.rectHasRoundedCorners(me._ht_info_popup_text_headline_3d)) {
		roundedRectShape = new THREE.Shape();
		let borderRadiusTL = me._ht_info_popup_text_headline_3d.userData.borderRadiusInnerShape.topLeft / 100.0;
		let borderRadiusTR = me._ht_info_popup_text_headline_3d.userData.borderRadiusInnerShape.topRight / 100.0;
		let borderRadiusBR = me._ht_info_popup_text_headline_3d.userData.borderRadiusInnerShape.bottomRight / 100.0;
		let borderRadiusBL = me._ht_info_popup_text_headline_3d.userData.borderRadiusInnerShape.bottomLeft / 100.0;
		roundedRectShape.moveTo((-width / 2.0) + borderRadiusTL, (height / 2.0));
		roundedRectShape.lineTo((width / 2.0) - borderRadiusTR, (height / 2.0));
		if (borderRadiusTR > 0.0) {
		roundedRectShape.arc(0, -borderRadiusTR, borderRadiusTR, Math.PI / 2.0, 2.0 * Math.PI, true);
		...
		geometry = new THREE.ShapeGeometry(roundedRectShape);
		geometry.name = 'ht_info_popup_text_headline_3d_geometry';
		geometry.computeBoundingBox();
		var min = geometry.boundingBox.min;
		var max = geometry.boundingBox.max;
		var offset = new THREE.Vector2(0 - min.x, 0 - min.y);
		...
		me._ht_info_popup_text_headline_3d.userData.backgroundColorAlpha = 1;
		me._ht_info_popup_text_headline_3d.userData.borderColorAlpha = 1;
		me._ht_info_popup_text_headline_3d.userData.setOpacityInternal = function(v) {
			me._ht_info_popup_text_headline_3d.material.opacity = v;
			if (me._ht_info_popup_text_headline_3d.userData.hasScrollbar) {
				me._ht_info_popup_text_headline_3d.userData.scrollbar.material.opacity = v;
				me._ht_info_popup_text_headline_3d.userData.scrollbarBg.material.opacity = v;
			}
			if (me._ht_info_popup_text_headline_3d.userData.ggSubElement) {
				me._ht_info_popup_text_headline_3d.userData.ggSubElement.material.opacity = v
				me._ht_info_popup_text_headline_3d.userData.ggSubElement.visible = (v>0 && me._ht_info_popup_text_headline_3d.userData.visible);
			}
			me._ht_info_popup_text_headline_3d.visible = (v>0 && me._ht_info_popup_text_headline_3d.userData.visible);
		}
		me._ht_info_popup_text_headline_3d.userData.setBackgroundColor = function(v) {
			me._ht_info_popup_text_headline_3d.material.color = v;
		}
		me._ht_info_popup_text_headline_3d.userData.setBackgroundColorAlpha = function(v) {
			me._ht_info_popup_text_headline_3d.userData.backgroundColorAlpha = v;
			me._ht_info_popup_text_headline_3d.userData.setOpacity(me._ht_info_popup_text_headline_3d.userData.opacity);
		}
		el.userData.createGeometry(0, 0, 0, 0, 0, 0, 0, 0);
		el.userData.backgroundColor = player.getTHREESkinColor('#ffffff');
		el.userData.textColor = '#ffffff';
		el.userData.textColorAlpha = 1;
		el.userData.cssClasses = ['varela'];
		var canvas = document.createElement('canvas');
		canvas.width = 1080;
		canvas.height = 60;
		el.userData.textCanvas = canvas;
		...
		el.userData.tmpCanvasContext = tmpCanvas.getContext('2d');
		el.userData.ggTextureFromCanvas = function() {
			var el = me._ht_info_popup_text_headline_3d;
			var canv = me._ht_info_popup_text_headline_3d.userData.textCanvas;
			var ctx = me._ht_info_popup_text_headline_3d.userData.textCanvasContext;
			var tmpCanv = me._ht_info_popup_text_headline_3d.userData.tmpCanvas;
			ctx.clearRect(0, 0, canv.width, canv.height);
			if (tmpCanv.width > 0 && tmpCanv.height > 0) {
				ctx.drawImage(tmpCanv, 0, canv.height / 2 - tmpCanv.height / 2);
			}
			var textTexture = new THREE.CanvasTexture(canv);
			textTexture.name = 'ht_info_popup_text_headline_3d_texture';
			textTexture.minFilter = THREE.LinearFilter;
			textTexture.colorSpace = THREE.LinearSRGBColorSpace;
			textTexture.wrapS = THREE.ClampToEdgeWrapping;
			textTexture.wrapT = THREE.ClampToEdgeWrapping;
			if (me._ht_info_popup_text_headline_3d.material.map) {
				me._ht_info_popup_text_headline_3d.material.map.dispose();
			}
			me._ht_info_popup_text_headline_3d.material.map = textTexture;
			me._ht_info_popup_text_headline_3d.material.needsUpdate = true;
			player.repaint();
		}
		el.userData.ggRenderText = function() {
			skin.removeChildren(me._ht_info_popup_text_headline_3d, 'scrollbar');
			skin.paintTextDivToCanvas(me._ht_info_popup_text_headline_3d, 'box-sizing: border-box; width: 540px; height: auto; font-size: 26px; font-weight: 600; color: rgba(255,255,255,1); text-align: left; white-space: nowrap; padding: 0px; overflow: hidden; text-overflow: ellipsis;' + '; color: ' + me._ht_info_popup_text_headline_3d.userData.textColor + ' !important;', true, false, false);
			me._ht_info_popup_text_headline_3d.userData.hasScrollbar = false;
		}
		el.userData.ggUpdateText=function(force) {
			var params = [];
			params.push(player._(String(player._(me.hotspot.title))));
		...
		el.userData.setBackgroundColor = function(v) {
			me._ht_info_popup_text_headline_3d.userData.backgroundColor = v;
		}
		el.userData.setBackgroundColorAlpha = function(v) {
			me._ht_info_popup_text_headline_3d.userData.backgroundColorAlpha = v;
		}
		el.userData.setTextColor = function(v) {
			me._ht_info_popup_text_headline_3d.userData.textColor = '#' + v.getHexString();
		}
		el.userData.setTextColorAlpha = function(v) {
			me._ht_info_popup_text_headline_3d.userData.textColorAlpha = v;
		}
		el.userData.ggId="ht_info_popup_text_headline_3d";
		me._ht_info_popup_text_headline_3d.userData.ggIsActive=function() {
			if ((this.parent) && (this.parent.ggIsActive)) {
				return this.parent.ggIsActive();
			}
			return false;
		...
		me._ht_info_popup_text_headline_3d.userData.ggUpdatePosition=function (useTransition) {
				me._ht_info_popup_text_headline_3d.userData.ggUpdateText(true);
		}
		me._ht_info_popup_text_3d.add(me._ht_info_popup_text_headline_3d);
		me._ht_info_popup_3d.add(me._ht_info_popup_text_3d);
		me._ht_info.add(me._ht_info_popup_3d);
		el = new THREE.Mesh();
			material = new THREE.MeshBasicMaterial( { color: player.getTHREESkinColor('#000000'), side : THREE.DoubleSide, transparent : (player.get3dModelType() != 2 || true) } ); 
			el.userData.transparentIn3d = material.transparent;
		...
		me._ht_info_popup.userData.backgroundColorAlpha = 0.666667;
		me._ht_info_popup.userData.borderColorAlpha = 1;
		me._ht_info_popup.userData.setOpacityInternal = function(v) {
			me._ht_info_popup.material.opacity = v * me._ht_info_popup.userData.backgroundColorAlpha;
		...
		me._ht_info_popup.logicBlock_alpha = function() {
			...
			if (me._ht_info_popup.ggCurrentLogicStateAlpha != newLogicStateAlpha) {
				...
				if (me._ht_info_popup.ggCurrentLogicStateAlpha == 0) {
					me._ht_info_popup.userData.transitionValue_alpha = 1;
					for (var i = 0; i < me._ht_info_popup.userData.transitions.length; i++) {
						if (me._ht_info_popup.userData.transitions[i].property == 'alpha') {
							clearInterval(me._ht_info_popup.userData.transitions[i].interval);
							me._ht_info_popup.userData.transitions.splice(i, 1);
							break;
						}
					}
					{
						...
						transition_alpha.property = 'alpha';
						transition_alpha.startTime = Date.now();
						transition_alpha.startAlpha = me._ht_info_popup.material ? me._ht_info_popup.material.opacity : me._ht_info_popup.userData.opacity;
						transition_alpha.interval = setInterval(() => {
							let currentTime = Date.now() - 0;
							let percentDone = 1.0 * (currentTime - transition_alpha.startTime) / 400;
							percentDone = Math.max(percentDone, 0.0);
							percentDone = Math.min(percentDone, 1.0);
							let tfval = -(Math.cos(Math.PI * percentDone) - 1) / 2;
							me._ht_info_popup.userData.setOpacity(transition_alpha.startAlpha + (me._ht_info_popup.userData.transitionValue_alpha - transition_alpha.startAlpha) * tfval);
							player.repaint();
							if (percentDone >= 1.0) {
								clearInterval(transition_alpha.interval);
								me._ht_info_popup.userData.transitions.splice(me._ht_info_popup.userData.transitions.indexOf(transition_alpha), 1);
							}
						}, 20);
						me._ht_info_popup.userData.transitions.push(transition_alpha);
					}
				}
				else {
					me._ht_info_popup.userData.transitionValue_alpha = 0;
					for (var i = 0; i < me._ht_info_popup.userData.transitions.length; i++) {
						if (me._ht_info_popup.userData.transitions[i].property == 'alpha') {
							clearInterval(me._ht_info_popup.userData.transitions[i].interval);
							me._ht_info_popup.userData.transitions.splice(i, 1);
		...
		el = new THREE.Group();
		el.userData.setOpacityInternal = function(v) {
			me._ht_info_popup_text.visible = (v>0 && me._ht_info_popup_text.userData.visible);
		}
		el.userData.width = 0;
		el.userData.height = 0;
		el.translateX(0.135);
		...
		el.userData.renderOrder = 3;
		el.userData.setOpacityInternal = function(v) {
			if (me._ht_info_popup_text.material) me._ht_info_popup_text.material.opacity = v;
			me._ht_info_popup_text.visible = (v>0 && me._ht_info_popup_text.userData.visible);
		}
		el.userData.isVisible = function() {
			let vis = me._ht_info_popup_text.visible
			let parentEl = me._ht_info_popup_text.parent;
			while (vis && parentEl) {
				if (!parentEl.visible) {
					vis = false;
					break;
		...
		el.userData.setOpacity = function(v) {
			me._ht_info_popup_text.userData.opacity = v;
			v = v * me._ht_info_popup_text.userData.parentOpacity;
			if (me._ht_info_popup_text.userData.setOpacityInternal) me._ht_info_popup_text.userData.setOpacityInternal(v);
			for (let i = 0; i < me._ht_info_popup_text.children.length; i++) {
				let child = me._ht_info_popup_text.children[i];
				if (child.userData.setParentOpacity) {
					child.userData.setParentOpacity(v);
				}
			};
		...
		el.userData.setParentOpacity = function(v) {
			me._ht_info_popup_text.userData.parentOpacity = v;
			v = v * me._ht_info_popup_text.userData.opacity
			if (me._ht_info_popup_text.userData.setOpacityInternal) me._ht_info_popup_text.userData.setOpacityInternal(v);
			for (let i = 0; i < me._ht_info_popup_text.children.length; i++) {
				let child = me._ht_info_popup_text.children[i];
				if (child.userData.setParentOpacity) {
		...
		el.userData.parentOpacity = 1.0;
		el.userData.transitions = [];
		me._ht_info_popup_text = el;
		el.userData.ggId="ht_info_popup_text";
		me._ht_info_popup_text.userData.ggIsActive=function() {
			if ((this.parent) && (this.parent.ggIsActive)) {
				return this.parent.ggIsActive();
			}
			return false;
		...
		me._ht_info_popup_text.userData.ggUpdatePosition=function (useTransition) {
		}
		el = new THREE.Mesh();
			material = new THREE.MeshBasicMaterial( {side : THREE.DoubleSide, transparent : (player.get3dModelType() != 2 || true) } ); 
			el.userData.transparentIn3d = material.transparent;
			material.name = 'ht_info_popup_text_body_material';
			el.material = material;
		el.translateX(0);
		el.translateY(-0.615);
		el.scale.set(1.00, 1.00, 1.0);
		...
		el.userData.borderRadius.bottomRight = el.userData.borderRadiusInnerShape.bottomRight = 0;
		el.userData.borderRadius.bottomLeft = el.userData.borderRadiusInnerShape.bottomLeft = 0;
		el.name = 'ht_info_popup_text_body';
		el.userData.x = 0;
		el.userData.y = -0.615;
		el.translateZ(0.120);
		el.userData.zIndex = -10000;
		...
		el.userData.renderOrder = 4;
		el.userData.isVisible = function() {
			let vis = me._ht_info_popup_text_body.visible
			let parentEl = me._ht_info_popup_text_body.parent;
			while (vis && parentEl) {
				if (!parentEl.visible) {
					vis = false;
					break;
		...
		el.userData.setOpacity = function(v) {
			me._ht_info_popup_text_body.userData.opacity = v;
			v = v * me._ht_info_popup_text_body.userData.parentOpacity;
			if (me._ht_info_popup_text_body.userData.setOpacityInternal) me._ht_info_popup_text_body.userData.setOpacityInternal(v);
			for (let i = 0; i < me._ht_info_popup_text_body.children.length; i++) {
				let child = me._ht_info_popup_text_body.children[i];
				if (child.userData.setParentOpacity) {
					child.userData.setParentOpacity(v);
				}
			};
		...
		el.userData.setParentOpacity = function(v) {
			me._ht_info_popup_text_body.userData.parentOpacity = v;
			v = v * me._ht_info_popup_text_body.userData.opacity
			if (me._ht_info_popup_text_body.userData.setOpacityInternal) me._ht_info_popup_text_body.userData.setOpacityInternal(v);
			for (let i = 0; i < me._ht_info_popup_text_body.children.length; i++) {
				let child = me._ht_info_popup_text_body.children[i];
				if (child.userData.setParentOpacity) {
		...
		el.userData.parentOpacity = 1.0;
		el.userData.transitions = [];
		me._ht_info_popup_text_body = el;
		el.userData.borderWidth = {};
		el.userData.borderWidth.default = {};
		el.userData.borderWidth.default.top = 0;
		el.userData.borderWidth.default.right = 0;
		...
		el.userData.borderRadiusInnerShape = {};
		el.userData.createGeometry = function(bwTop, bwRight, bwBottom, bwLeft, brTopLeft, brTopRight, brBottomRight, brBottomLeft) {
			let el = me._ht_info_popup_text_body;
			skin.disposeGeometryAndMaterial(el);
			skin.removeChildren(el, 'subElement');
			if (typeof(bwTop) != 'undefined') {
				el.userData.borderWidth.top = bwTop;
			...
			let width = el.userData.width / 100.0;
			let height = el.userData.height / 100.0;
			skin.rectCalcBorderRadiiInnerShape(me._ht_info_popup_text_body);
			if (skin.rectHasRoundedCorners(me._ht_info_popup_text_body)) {
		roundedRectShape = new THREE.Shape();
		let borderRadiusTL = me._ht_info_popup_text_body.userData.borderRadiusInnerShape.topLeft / 100.0;
		let borderRadiusTR = me._ht_info_popup_text_body.userData.borderRadiusInnerShape.topRight / 100.0;
		let borderRadiusBR = me._ht_info_popup_text_body.userData.borderRadiusInnerShape.bottomRight / 100.0;
		let borderRadiusBL = me._ht_info_popup_text_body.userData.borderRadiusInnerShape.bottomLeft / 100.0;
		roundedRectShape.moveTo((-width / 2.0) + borderRadiusTL, (height / 2.0));
		roundedRectShape.lineTo((width / 2.0) - borderRadiusTR, (height / 2.0));
		if (borderRadiusTR > 0.0) {
		roundedRectShape.arc(0, -borderRadiusTR, borderRadiusTR, Math.PI / 2.0, 2.0 * Math.PI, true);
		...
		geometry = new THREE.ShapeGeometry(roundedRectShape);
		geometry.name = 'ht_info_popup_text_body_geometry';
		geometry.computeBoundingBox();
		var min = geometry.boundingBox.min;
		var max = geometry.boundingBox.max;
		var offset = new THREE.Vector2(0 - min.x, 0 - min.y);
		...
		me._ht_info_popup_text_body.userData.backgroundColorAlpha = 1;
		me._ht_info_popup_text_body.userData.borderColorAlpha = 1;
		me._ht_info_popup_text_body.userData.setOpacityInternal = function(v) {
			me._ht_info_popup_text_body.material.opacity = v;
			if (me._ht_info_popup_text_body.userData.hasScrollbar) {
				me._ht_info_popup_text_body.userData.scrollbar.material.opacity = v;
				me._ht_info_popup_text_body.userData.scrollbarBg.material.opacity = v;
			}
			if (me._ht_info_popup_text_body.userData.ggSubElement) {
				me._ht_info_popup_text_body.userData.ggSubElement.material.opacity = v
				me._ht_info_popup_text_body.userData.ggSubElement.visible = (v>0 && me._ht_info_popup_text_body.userData.visible);
			}
			me._ht_info_popup_text_body.visible = (v>0 && me._ht_info_popup_text_body.userData.visible);
		}
		me._ht_info_popup_text_body.userData.setBackgroundColor = function(v) {
			me._ht_info_popup_text_body.material.color = v;
		}
		me._ht_info_popup_text_body.userData.setBackgroundColorAlpha = function(v) {
			me._ht_info_popup_text_body.userData.backgroundColorAlpha = v;
			me._ht_info_popup_text_body.userData.setOpacity(me._ht_info_popup_text_body.userData.opacity);
		}
		el.userData.createGeometry(0, 0, 0, 0, 0, 0, 0, 0);
		el.userData.backgroundColor = player.getTHREESkinColor('#ffffff');
		el.userData.textColor = '#ffffff';
		...
		el.userData.tmpCanvasContext = tmpCanvas.getContext('2d');
		el.userData.ggTextureFromCanvas = function() {
			var el = me._ht_info_popup_text_body;
			var canv = me._ht_info_popup_text_body.userData.textCanvas;
			var ctx = me._ht_info_popup_text_body.userData.textCanvasContext;
			var tmpCanv = me._ht_info_popup_text_body.userData.tmpCanvas;
			ctx.clearRect(0, 0, canv.width, canv.height);
			if (tmpCanv.width > 0 && tmpCanv.height > 0) {
				ctx.drawImage(tmpCanv, 0, ( me._ht_info_popup_text_body.userData.scrollPosPercent ? tmpCanv.height * me._ht_info_popup_text_body.userData.scrollPosPercent : 0), canv.width, canv.height, 0, 0, canv.width, canv.height);
			}
			var textTexture = new THREE.CanvasTexture(canv);
			textTexture.name = 'ht_info_popup_text_body_texture';
			textTexture.minFilter = THREE.LinearFilter;
			textTexture.colorSpace = THREE.LinearSRGBColorSpace;
			textTexture.wrapS = THREE.ClampToEdgeWrapping;
			textTexture.wrapT = THREE.ClampToEdgeWrapping;
			if (me._ht_info_popup_text_body.material.map) {
				me._ht_info_popup_text_body.material.map.dispose();
			}
			me._ht_info_popup_text_body.material.map = textTexture;
			me._ht_info_popup_text_body.material.needsUpdate = true;
			player.repaint();
		}
		el.userData.ggRenderText = function() {
			skin.removeChildren(me._ht_info_popup_text_body, 'scrollbar');
			skin.paintTextDivToCanvas(me._ht_info_popup_text_body, 'box-sizing: border-box; width: 27px; height: auto; font-size: 16px; font-weight: 500; color: rgba(255,255,255,1); text-align: left; white-space: pre-line; padding: 0px; overflow: hidden; overflow-y: auto;line-height: 1.4;' + '; color: ' + me._ht_info_popup_text_body.userData.textColor + ' !important;', false, false, true, true);
			if (me._ht_info_popup_text_body.userData.totalHeightCanv > (me._ht_info_popup_text_body.userData.height)) {
				skin.paintTextDivToCanvas(me._ht_info_popup_text_body, 'box-sizing: border-box; width: 7px; height: auto; font-size: 16px; font-weight: 500; color: rgba(255,255,255,1); text-align: left; white-space: pre-line; padding: 0px; overflow: hidden; overflow-y: auto;line-height: 1.4;' + '; color: ' + me._ht_info_popup_text_body.userData.textColor + ' !important;', false, false, true);
			} else {
			skin.paintTextDivToCanvas(me._ht_info_popup_text_body, 'box-sizing: border-box; width: 27px; height: auto; font-size: 16px; font-weight: 500; color: rgba(255,255,255,1); text-align: left; white-space: pre-line; padding: 0px; overflow: hidden; overflow-y: auto;line-height: 1.4;' + '; color: ' + me._ht_info_popup_text_body.userData.textColor + ' !important;', false, false, true);
			}
			me._ht_info_popup_text_body.userData.scrollPosPercent = 0.0
			if (me._ht_info_popup_text_body.userData.totalHeightCanv > ((me._ht_info_popup_text_body.userData.height))) {
				me._ht_info_popup_text_body.userData.pagePercent = ((me._ht_info_popup_text_body.userData.height) - me._ht_info_popup_text_body.userData.lineHeight) / me._ht_info_popup_text_body.userData.totalHeightCanv;
				me._ht_info_popup_text_body.userData.maxScrollPercent = (me._ht_info_popup_text_body.userData.totalHeightCanv - (1 * (me._ht_info_popup_text_body.userData.height))) / me._ht_info_popup_text_body.userData.totalHeightCanv;
				geometry = new THREE.PlaneGeometry(20 / 100.0, me._ht_info_popup_text_body.userData.height / 100.0, 5, 5 );
				geometry.name = 'ht_info_popup_text_body_scrollbarBgGeometry';
				material = new THREE.MeshBasicMaterial( {color: 0x7f7f7f, side: THREE.DoubleSide, transparent: true } );
				material.name = 'ht_info_popup_text_body_scrollbarBgMaterial';
				me._ht_info_popup_text_body.userData.scrollbarBg = new THREE.Mesh( geometry, material );
				me._ht_info_popup_text_body.userData.scrollbarBg.name = 'ht_info_popup_text_body_scrollbarBg';
				me._ht_info_popup_text_body.add(me._ht_info_popup_text_body.userData.scrollbarBg);
				me._ht_info_popup_text_body.userData.scrollbarXPos = (me._ht_info_popup_text_body.userData.width - 20) / 200.0;
				me._ht_info_popup_text_body.userData.scrollbarBg.position.x = me._ht_info_popup_text_body.userData.scrollbarXPos;
				me._ht_info_popup_text_body.userData.scrollbarBg.position.z = me._ht_info_popup_text_body.position.z + 0.01;
				me._ht_info_popup_text_body.userData.scrollbarBg.userData.stopPropagation = true;
				me._ht_info_popup_text_body.userData.scrollbarHeight = ((1 * me._ht_info_popup_text_body.userData.height) / me._ht_info_popup_text_body.userData.totalHeightCanv) * me._ht_info_popup_text_body.userData.height;
				geometry = new THREE.PlaneGeometry(20 / 100.0, me._ht_info_popup_text_body.userData.scrollbarHeight / 100.0, 5, 5 );
				geometry.name = 'ht_info_popup_text_body_scrollbarGeometry';
				material = new THREE.MeshBasicMaterial( {color: 0xbfbfbf, side: THREE.DoubleSide, transparent: true } );
				material.name = 'ht_info_popup_text_body_scrollbarMaterial';
				me._ht_info_popup_text_body.userData.scrollbar = new THREE.Mesh( geometry, material );
				me._ht_info_popup_text_body.userData.scrollbar.name = 'ht_info_popup_text_body_scrollbar';
				me._ht_info_popup_text_body.add(me._ht_info_popup_text_body.userData.scrollbar);
				me._ht_info_popup_text_body.userData.scrollbar.position.x = me._ht_info_popup_text_body.userData.scrollbarXPos;
				me._ht_info_popup_text_body.userData.scrollbar.position.z = me._ht_info_popup_text_body.position.z + 0.02;
				me._ht_info_popup_text_body.userData.scrollbarYPosMin = (me._ht_info_popup_text_body.userData.height - me._ht_info_popup_text_body.userData.scrollbarHeight) / 200.0;
				me._ht_info_popup_text_body.userData.scrollbarYPosMax = me._ht_info_popup_text_body.userData.scrollbarYPosMin - (me._ht_info_popup_text_body.userData.height - me._ht_info_popup_text_body.userData.scrollbarHeight) / 100.0;
				me._ht_info_popup_text_body.userData.scrollbar.position.y = me._ht_info_popup_text_body.userData.scrollbarYPosMin;
				geometry = new THREE.PlaneGeometry(20 / 100.0, me._ht_info_popup_text_body.userData.height / 200.0, 5, 5 );
				geometry.name = 'ht_info_popup_text_body_scrollbarPageDownGeometry';
				material = new THREE.MeshBasicMaterial( {color: 0x000000, side: THREE.DoubleSide, transparent: true } );
				material.name = 'ht_info_popup_text_body_scrollbarPageDownMaterial';
				me._ht_info_popup_text_body.userData.scrollbarPageDown = new THREE.Mesh( geometry, material );
				me._ht_info_popup_text_body.userData.scrollbarPageDown.name = 'ht_info_popup_text_body_scrollbarPageDown';
				me._ht_info_popup_text_body.userData.scrollbarPageDown.userData.onclick = function() {
					me._ht_info_popup_text_body.userData.scrollPosPercent -= me._ht_info_popup_text_body.userData.pagePercent;
					me._ht_info_popup_text_body.userData.scrollPosPercent = Math.max(me._ht_info_popup_text_body.userData.scrollPosPercent, 0);
					me._ht_info_popup_text_body.userData.ggTextureFromCanvas();
					me._ht_info_popup_text_body.userData.scrollbar.position.y += (me._ht_info_popup_text_body.userData.height * me._ht_info_popup_text_body.userData.pagePercent) / 100.0;
					me._ht_info_popup_text_body.userData.scrollbar.position.y = Math.min(me._ht_info_popup_text_body.userData.scrollbar.position.y, me._ht_info_popup_text_body.userData.scrollbarYPosMin);
				}
				me._ht_info_popup_text_body.userData.scrollbarPageDown.position.x = me._ht_info_popup_text_body.userData.scrollbarXPos;
				me._ht_info_popup_text_body.userData.scrollbarPageDown.position.y = me._ht_info_popup_text_body.userData.height / 400.0;
				me._ht_info_popup_text_body.userData.scrollbarPageDown.position.z = me._ht_info_popup_text_body.position.z + 0.05;
				me._ht_info_popup_text_body.userData.scrollbarPageDown.userData.stopPropagation = true;
				me._ht_info_popup_text_body.userData.scrollbarPageDown.userData.clickInvisible = true;
				me._ht_info_popup_text_body.userData.scrollbarPageDown.visible = false;
				me._ht_info_popup_text_body.add(me._ht_info_popup_text_body.userData.scrollbarPageDown);
				geometry = new THREE.PlaneGeometry(20 / 100.0, me._ht_info_popup_text_body.userData.height / 200.0, 5, 5 );
				geometry.name = 'ht_info_popup_text_body_scrollbarPageUpGeometry';
				material = new THREE.MeshBasicMaterial( {color: 0x000000, side: THREE.DoubleSide, transparent: true } );
				material.name = 'ht_info_popup_text_body_scrollbarPageUpMaterial';
				me._ht_info_popup_text_body.userData.scrollbarPageUp = new THREE.Mesh( geometry, material );
				me._ht_info_popup_text_body.userData.scrollbarPageUp.name = 'ht_info_popup_text_body_scrollbarPageUp';
				me._ht_info_popup_text_body.userData.scrollbarPageUp.userData.onclick = function() {
					me._ht_info_popup_text_body.userData.scrollPosPercent += me._ht_info_popup_text_body.userData.pagePercent;
					me._ht_info_popup_text_body.userData.scrollPosPercent = Math.min(me._ht_info_popup_text_body.userData.scrollPosPercent, me._ht_info_popup_text_body.userData.maxScrollPercent);
					me._ht_info_popup_text_body.userData.ggTextureFromCanvas();
					me._ht_info_popup_text_body.userData.scrollbar.position.y -= (me._ht_info_popup_text_body.userData.height * me._ht_info_popup_text_body.userData.pagePercent) / 100.0;
					me._ht_info_popup_text_body.userData.scrollbar.position.y = Math.max(me._ht_info_popup_text_body.userData.scrollbar.position.y, me._ht_info_popup_text_body.userData.scrollbarYPosMax);
				}
				me._ht_info_popup_text_body.userData.scrollbarPageUp.position.x = me._ht_info_popup_text_body.userData.scrollbarXPos;
				me._ht_info_popup_text_body.userData.scrollbarPageUp.position.y = -me._ht_info_popup_text_body.userData.height / 400.0;
				me._ht_info_popup_text_body.userData.scrollbarPageUp.position.z = me._ht_info_popup_text_body.position.z + 0.05;
				me._ht_info_popup_text_body.userData.scrollbarPageUp.userData.stopPropagation = true;
				me._ht_info_popup_text_body.userData.scrollbarPageUp.userData.clickInvisible = true;
				me._ht_info_popup_text_body.userData.scrollbarPageUp.visible = false;
				me._ht_info_popup_text_body.add(me._ht_info_popup_text_body.userData.scrollbarPageUp);
				me._ht_info_popup_text_body.userData.hasScrollbar = true;
			} else {
				me._ht_info_popup_text_body.userData.hasScrollbar = false;
			}
		}
		el.userData.ggUpdateText=function(force) {
			var params = [];
		...
		el.userData.setBackgroundColor = function(v) {
			me._ht_info_popup_text_body.userData.backgroundColor = v;
		}
		el.userData.setBackgroundColorAlpha = function(v) {
			me._ht_info_popup_text_body.userData.backgroundColorAlpha = v;
		}
		el.userData.setTextColor = function(v) {
			me._ht_info_popup_text_body.userData.textColor = '#' + v.getHexString();
		}
		el.userData.setTextColorAlpha = function(v) {
			me._ht_info_popup_text_body.userData.textColorAlpha = v;
		}
		el.userData.ggId="ht_info_popup_text_body";
		me._ht_info_popup_text_body.userData.ggIsActive=function() {
			if ((this.parent) && (this.parent.ggIsActive)) {
				return this.parent.ggIsActive();
			}
			return false;
		...
		me._ht_info_popup_text_body.userData.ggUpdatePosition=function (useTransition) {
				me._ht_info_popup_text_body.userData.ggUpdateText(true);
		}
		me._ht_info_popup_text.add(me._ht_info_popup_text_body);
		el = new THREE.Mesh();
			material = new THREE.MeshBasicMaterial( {side : THREE.DoubleSide, transparent : (player.get3dModelType() != 2 || true) } ); 
			el.userData.transparentIn3d = material.transparent;
			material.name = 'ht_info_popup_text_headline_material';
			el.material = material;
		el.translateX(0);
		el.translateY(-0.015);
		el.scale.set(1.00, 1.00, 1.0);
		...
		el.userData.borderRadius.bottomRight = el.userData.borderRadiusInnerShape.bottomRight = 0;
		el.userData.borderRadius.bottomLeft = el.userData.borderRadiusInnerShape.bottomLeft = 0;
		el.name = 'ht_info_popup_text_headline';
		el.userData.x = 0;
		el.userData.y = -0.015;
		el.translateZ(0.150);
		el.userData.zIndex = -10000;
		...
		el.userData.isVisible = function() {
			let vis = me._ht_info_popup_text_headline.visible
			let parentEl = me._ht_info_popup_text_headline.parent;
			while (vis && parentEl) {
				if (!parentEl.visible) {
					vis = false;
					break;
		...
		el.userData.setOpacity = function(v) {
			me._ht_info_popup_text_headline.userData.opacity = v;
			v = v * me._ht_info_popup_text_headline.userData.parentOpacity;
			if (me._ht_info_popup_text_headline.userData.setOpacityInternal) me._ht_info_popup_text_headline.userData.setOpacityInternal(v);
			for (let i = 0; i < me._ht_info_popup_text_headline.children.length; i++) {
				let child = me._ht_info_popup_text_headline.children[i];
				if (child.userData.setParentOpacity) {
					child.userData.setParentOpacity(v);
				}
			};
		...
		el.userData.setParentOpacity = function(v) {
			me._ht_info_popup_text_headline.userData.parentOpacity = v;
			v = v * me._ht_info_popup_text_headline.userData.opacity
			if (me._ht_info_popup_text_headline.userData.setOpacityInternal) me._ht_info_popup_text_headline.userData.setOpacityInternal(v);
			for (let i = 0; i < me._ht_info_popup_text_headline.children.length; i++) {
				let child = me._ht_info_popup_text_headline.children[i];
				if (child.userData.setParentOpacity) {
		...
		el.userData.parentOpacity = 1.0;
		el.userData.transitions = [];
		me._ht_info_popup_text_headline = el;
		el.userData.borderWidth = {};
		el.userData.borderWidth.default = {};
		el.userData.borderWidth.default.top = 0;
		el.userData.borderWidth.default.right = 0;
		...
		el.userData.borderRadiusInnerShape = {};
		el.userData.createGeometry = function(bwTop, bwRight, bwBottom, bwLeft, brTopLeft, brTopRight, brBottomRight, brBottomLeft) {
			let el = me._ht_info_popup_text_headline;
			skin.disposeGeometryAndMaterial(el);
			skin.removeChildren(el, 'subElement');
			if (typeof(bwTop) != 'undefined') {
				el.userData.borderWidth.top = bwTop;
			...
			let width = el.userData.width / 100.0;
			let height = el.userData.height / 100.0;
			skin.rectCalcBorderRadiiInnerShape(me._ht_info_popup_text_headline);
			if (skin.rectHasRoundedCorners(me._ht_info_popup_text_headline)) {
		roundedRectShape = new THREE.Shape();
		let borderRadiusTL = me._ht_info_popup_text_headline.userData.borderRadiusInnerShape.topLeft / 100.0;
		let borderRadiusTR = me._ht_info_popup_text_headline.userData.borderRadiusInnerShape.topRight / 100.0;
		let borderRadiusBR = me._ht_info_popup_text_headline.userData.borderRadiusInnerShape.bottomRight / 100.0;
		let borderRadiusBL = me._ht_info_popup_text_headline.userData.borderRadiusInnerShape.bottomLeft / 100.0;
		roundedRectShape.moveTo((-width / 2.0) + borderRadiusTL, (height / 2.0));
		roundedRectShape.lineTo((width / 2.0) - borderRadiusTR, (height / 2.0));
		if (borderRadiusTR > 0.0) {
		roundedRectShape.arc(0, -borderRadiusTR, borderRadiusTR, Math.PI / 2.0, 2.0 * Math.PI, true);
		...
		geometry = new THREE.ShapeGeometry(roundedRectShape);
		geometry.name = 'ht_info_popup_text_headline_geometry';
		geometry.computeBoundingBox();
		var min = geometry.boundingBox.min;
		var max = geometry.boundingBox.max;
		var offset = new THREE.Vector2(0 - min.x, 0 - min.y);
		...
		me._ht_info_popup_text_headline.userData.backgroundColorAlpha = 1;
		me._ht_info_popup_text_headline.userData.borderColorAlpha = 1;
		me._ht_info_popup_text_headline.userData.setOpacityInternal = function(v) {
			me._ht_info_popup_text_headline.material.opacity = v;
			if (me._ht_info_popup_text_headline.userData.hasScrollbar) {
				me._ht_info_popup_text_headline.userData.scrollbar.material.opacity = v;
				me._ht_info_popup_text_headline.userData.scrollbarBg.material.opacity = v;
			}
			if (me._ht_info_popup_text_headline.userData.ggSubElement) {
				me._ht_info_popup_text_headline.userData.ggSubElement.material.opacity = v
				me._ht_info_popup_text_headline.userData.ggSubElement.visible = (v>0 && me._ht_info_popup_text_headline.userData.visible);
			}
			me._ht_info_popup_text_headline.visible = (v>0 && me._ht_info_popup_text_headline.userData.visible);
		}
		me._ht_info_popup_text_headline.userData.setBackgroundColor = function(v) {
			me._ht_info_popup_text_headline.material.color = v;
		}
		me._ht_info_popup_text_headline.userData.setBackgroundColorAlpha = function(v) {
			me._ht_info_popup_text_headline.userData.backgroundColorAlpha = v;
			me._ht_info_popup_text_headline.userData.setOpacity(me._ht_info_popup_text_headline.userData.opacity);
		}
		el.userData.createGeometry(0, 0, 0, 0, 0, 0, 0, 0);
		el.userData.backgroundColor = player.getTHREESkinColor('#ffffff');
		el.userData.textColor = '#ffffff';
		...
		el.userData.tmpCanvasContext = tmpCanvas.getContext('2d');
		el.userData.ggTextureFromCanvas = function() {
			var el = me._ht_info_popup_text_headline;
			var canv = me._ht_info_popup_text_headline.userData.textCanvas;
			var ctx = me._ht_info_popup_text_headline.userData.textCanvasContext;
			var tmpCanv = me._ht_info_popup_text_headline.userData.tmpCanvas;
			ctx.clearRect(0, 0, canv.width, canv.height);
			if (tmpCanv.width > 0 && tmpCanv.height > 0) {
				ctx.drawImage(tmpCanv, 0, canv.height / 2 - tmpCanv.height / 2);
			}
			var textTexture = new THREE.CanvasTexture(canv);
			textTexture.name = 'ht_info_popup_text_headline_texture';
			textTexture.minFilter = THREE.LinearFilter;
			textTexture.colorSpace = THREE.LinearSRGBColorSpace;
			textTexture.wrapS = THREE.ClampToEdgeWrapping;
			textTexture.wrapT = THREE.ClampToEdgeWrapping;
			if (me._ht_info_popup_text_headline.material.map) {
				me._ht_info_popup_text_headline.material.map.dispose();
			}
			me._ht_info_popup_text_headline.material.map = textTexture;
			me._ht_info_popup_text_headline.material.needsUpdate = true;
			player.repaint();
		}
		el.userData.ggRenderText = function() {
			skin.removeChildren(me._ht_info_popup_text_headline, 'scrollbar');
			skin.paintTextDivToCanvas(me._ht_info_popup_text_headline, 'box-sizing: border-box; width: 27px; height: auto; font-size: 26px; font-weight: 600; color: rgba(255,255,255,1); text-align: left; white-space: nowrap; padding: 0px; overflow: hidden; text-overflow: ellipsis;' + '; color: ' + me._ht_info_popup_text_headline.userData.textColor + ' !important;', true, false, false);
			me._ht_info_popup_text_headline.userData.hasScrollbar = false;
		}
		el.userData.ggUpdateText=function(force) {
			var params = [];
			params.push(player._(String(player._(me.hotspot.title))));
		...
		el.userData.setBackgroundColor = function(v) {
			me._ht_info_popup_text_headline.userData.backgroundColor = v;
		}
		el.userData.setBackgroundColorAlpha = function(v) {
			me._ht_info_popup_text_headline.userData.backgroundColorAlpha = v;
		}
		el.userData.setTextColor = function(v) {
			me._ht_info_popup_text_headline.userData.textColor = '#' + v.getHexString();
		}
		el.userData.setTextColorAlpha = function(v) {
			me._ht_info_popup_text_headline.userData.textColorAlpha = v;
		}
		el.userData.ggId="ht_info_popup_text_headline";
		me._ht_info_popup_text_headline.userData.ggIsActive=function() {
			if ((this.parent) && (this.parent.ggIsActive)) {
				return this.parent.ggIsActive();
			}
			return false;
		...
		me._ht_info_popup_text_headline.userData.ggUpdatePosition=function (useTransition) {
				me._ht_info_popup_text_headline.userData.ggUpdateText(true);
		}
		me._ht_info_popup_text.add(me._ht_info_popup_text_headline);
		me._ht_info_popup.add(me._ht_info_popup_text);
		me._ht_info.add(me._ht_info_popup);
		el = new THREE.Mesh();
		el.translateX(0);
		el.translateY(0);
		el.scale.set(1.00, 1.00, 1.0);
		...
		el.userData.setOpacityInternal = function(v) {
			if (me._ht_info_popup_close.userData.materialNormal) me._ht_info_popup_close.userData.materialNormal.opacity = v;
			if (me._ht_info_popup_close.userData.materialOver) me._ht_info_popup_close.userData.materialOver.opacity = v;
			if (me._ht_info_popup_close.userData.materialActive) me._ht_info_popup_close.userData.materialActive.opacity = v;
			me._ht_info_popup_close.visible = (v>0 && me._ht_info_popup_close.userData.visible);
		}
		loader = new THREE.TextureLoader();
		texture = loader.load('data:image/png;base64,'+
	'9yWOjCTj8CHcSXZwJ3+WfQQny5f4RsxNeuLcsEui2GyjDBQnyjEItZk/eK0Ed8LUY/TQghvharXyYwzqZoPzZILMT7bIvnbUJM8bUceZrA9auxJFvXLSYsSY5C5epS1DxlV1pm29w1rs9yeGUY+wEwU0q9esQ1UsWcVTlsaokLt3dAYvOt0YLrkypO9PWIzAjADdadf1BKvafIKwiCIAiCIAiCIJTCL4mWuqTbJ2YQAAAAAElFTkSuQmCC');
		texture.colorSpace = player.getTextureColorSpace();
		material = new THREE.MeshBasicMaterial( {map: texture, side: THREE.DoubleSide, transparent: true} );
		material.name = 'ht_info_popup_close_material';
		el.userData.materialNormal = material;
		el.userData.materialCurrent = material;
		textureOver = loader.load('data:image/png;base64,'+
	''+
	'RfXRvPISKHDhLSyIB0bLYcZzh+J4Lkrk2AM4TBg01r2d/fAlcS6ZUDZgUKA9AFcTQ6Ep8TETJkwKvhrPRYlb+ROZi0tvYxR7DgcF2ntUavZsvK8gCIIgCIIgCILwv/AX9U/pF5mbk9IAAAAASUVORK5CYII=');
		textureOver.colorSpace = player.getTextureColorSpace();
		el.userData.materialOver = new THREE.MeshBasicMaterial( {map: textureOver, side: THREE.DoubleSide, transparent: true} );
		el.userData.materialOver.name = 'ht_info_popup_close_materialOver';
		el.userData.createGeometry = function(brTopLeft, brTopRight, brBottomRight, brBottomLeft) {
			let el = me._ht_info_popup_close;
			skin.disposeGeometryAndMaterial(el);
			skin.removeChildren(el, 'subElement');
			let minDim = Math.min(el.userData.width, el.userData.height) / 2;
			el.userData.borderRadiusInnerShape.topLeft = Math.min(brTopLeft, minDim);
			...
			el.userData.borderRadiusInnerShape.bottomRight = Math.min(brBottomRight, minDim);
			el.userData.borderRadiusInnerShape.bottomLeft = Math.min(brBottomLeft, minDim);
		geometry = new THREE.PlaneGeometry(me._ht_info_popup_close.userData.width / 100.0, me._ht_info_popup_close.userData.height / 100.0, 5, 5 );
		...
		me._ht_info_popup_close.logicBlock_alpha = function() {
			...
			if (me._ht_info_popup_close.ggCurrentLogicStateAlpha != newLogicStateAlpha) {
				...
				if (me._ht_info_popup_close.ggCurrentLogicStateAlpha == 0) {
					me._ht_info_popup_close.userData.transitionValue_alpha = 1;
					for (var i = 0; i < me._ht_info_popup_close.userData.transitions.length; i++) {
						if (me._ht_info_popup_close.userData.transitions[i].property == 'alpha') {
							clearInterval(me._ht_info_popup_close.userData.transitions[i].interval);
							me._ht_info_popup_close.userData.transitions.splice(i, 1);
							break;
						}
					}
					{
						...
						transition_alpha.property = 'alpha';
						transition_alpha.startTime = Date.now();
						transition_alpha.startAlpha = me._ht_info_popup_close.material ? me._ht_info_popup_close.material.opacity : me._ht_info_popup_close.userData.opacity;
						transition_alpha.interval = setInterval(() => {
							let currentTime = Date.now() - 0;
							...
							percentDone = Math.min(percentDone, 1.0);
							let tfval = -(Math.cos(Math.PI * percentDone) - 1) / 2;
							me._ht_info_popup_close.userData.setOpacity(transition_alpha.startAlpha + (me._ht_info_popup_close.userData.transitionValue_alpha - transition_alpha.startAlpha) * tfval);
							player.repaint();
							if (percentDone >= 1.0) {
								clearInterval(transition_alpha.interval);
								me._ht_info_popup_close.userData.transitions.splice(me._ht_info_popup_close.userData.transitions.indexOf(transition_alpha), 1);
							}
						}, 20);
						me._ht_info_popup_close.userData.transitions.push(transition_alpha);
					}
				}
				else {
					me._ht_info_popup_close.userData.transitionValue_alpha = 0;
					for (var i = 0; i < me._ht_info_popup_close.userData.transitions.length; i++) {
						if (me._ht_info_popup_close.userData.transitions[i].property == 'alpha') {
							clearInterval(me._ht_info_popup_close.userData.transitions[i].interval);
							me._ht_info_popup_close.userData.transitions.splice(i, 1);
		...
		me._ht_info_popup_close.logicBlock_zindex = function() {
			var newLogicStateZIndex;
			if (
				((player.is3dModel() == true))
			)
			...
			if (me._ht_info_popup_close.ggCurrentLogicStateZIndex != newLogicStateZIndex) {
				me._ht_info_popup_close.ggCurrentLogicStateZIndex = newLogicStateZIndex;
				if (me._ht_info_popup_close.ggCurrentLogicStateZIndex == 0) {
					me._ht_info_popup_close.userData.zIndexCurrent = 1;
			me._ht_info_popup_close.traverse((obj)=>{
				let level = skin.getDepthFrom(me._ht_info_popup_close, obj);
				let treePos = obj.parent ? obj.parent.children.indexOf(obj) : 0;
				if (1 > 0) {
					if (obj == me._ht_info_popup_close) {
						obj.renderOrder = 10000 + 1000*1
					} else {
						let parentOrder = obj.parent.renderOrder;
						let isSkinElement = obj.userData.hasOwnProperty('ggId');
					...
					obj.renderOrder = me._ht_info_popup_close.userData.renderOrder + level;
				}
				if (obj.material) {
					if (player.get3dModelType() != 2) {
						obj.material.depthTest = false;
			...
			player.repaint();
					...
					me._ht_info_popup_close.userData.zIndexCurrent = -10000;
			me._ht_info_popup_close.traverse((obj)=>{
				let level = skin.getDepthFrom(me._ht_info_popup_close, obj);
				let treePos = obj.parent ? obj.parent.children.indexOf(obj) : 0;
				if (-10000 > 0) {
		...
		me._ht_info_popup_close.userData.onclick=function (e) {
			...
			if (
				...
				me._ht_info_popup_close.userData.transitionValue_alpha = 0;
				for (var i = 0; i < me._ht_info_popup_text.userData.transitions.length; i++) {
					if (me._ht_info_popup_text.userData.transitions[i].property == 'alpha') {
						clearInterval(me._ht_info_popup_text.userData.transitions[i].interval);
						me._ht_info_popup_text.userData.transitions.splice(i, 1);
						break;
					}
				}
				{
					...
					transition_alpha.property = 'alpha';
					transition_alpha.startTime = Date.now();
					transition_alpha.startAlpha = me._ht_info_popup_text.material ? me._ht_info_popup_text.material.opacity : me._ht_info_popup_text.userData.opacity;
					transition_alpha.interval = setInterval(() => {
						let currentTime = Date.now() - 0;
						let percentDone = 1.0 * (currentTime - transition_alpha.startTime) / 200;
						percentDone = Math.max(percentDone, 0.0);
						...
						me._ht_info_popup_text.userData.setOpacity(transition_alpha.startAlpha + (me._ht_info_popup_close.userData.transitionValue_alpha - transition_alpha.startAlpha) * tfval);
						player.repaint();
						if (percentDone >= 1.0) {
							clearInterval(transition_alpha.interval);
							me._ht_info_popup_text.userData.transitions.splice(me._ht_info_popup_text.userData.transitions.indexOf(transition_alpha), 1);
						}
					}, 20);
					me._ht_info_popup_text.userData.transitions.push(transition_alpha);
				}
			}
			if (
				(
		...
		me._ht_info_popup_close.userData.onmouseenter=function (e) {
			player.setOverrideCursor('pointer');
			me._ht_info_popup_close.material = me._ht_info_popup_close.userData.materialCurrent = me._ht_info_popup_close.userData.materialOver;
			me.elementMouseOver['ht_info_popup_close']=true;
		}
		me._ht_info_popup_close.userData.onmouseleave=function (e) {
			player.setOverrideCursor('default');
			me._ht_info_popup_close.material = me._ht_info_popup_close.userData.materialCurrent = me._ht_info_popup_close.userData.materialNormal;
			me.elementMouseOver['ht_info_popup_close']=false;
		}
		me._ht_info_popup_close.userData.ggUpdatePosition=function (useTransition) {
		}
		me._ht_info.add(me._ht_info_popup_close);
		el = new THREE.Mesh();
			material = new THREE.MeshBasicMaterial( {side : THREE.DoubleSide, transparent : (player.get3dModelType() != 2 || true) } ); 
			el.userData.transparentIn3d = material.transparent;
		...
		me._ht_info_tooltip.userData.backgroundColorAlpha = 1;
		...
		el.userData.ggRenderText = function() {
			...
			skin.paintTextDivToCanvas(me._ht_info_tooltip, 'box-sizing: border-box; width: auto; height: auto; font-size: 16px; font-weight: 500; color: rgba(255,255,255,1); text-align: center; white-space: pre; padding: 0px; overflow: hidden;' + '; color: ' + me._ht_info_tooltip.userData.textColor + ' !important;', false, true, false);
		...
		me._ht_info_tooltip.logicBlock_alpha = function() {
			...
			if (me._ht_info_tooltip.ggCurrentLogicStateAlpha != newLogicStateAlpha) {
				...
				if (me._ht_info_tooltip.ggCurrentLogicStateAlpha == 0) {
					me._ht_info_tooltip.userData.transitionValue_alpha = 1;
					for (var i = 0; i < me._ht_info_tooltip.userData.transitions.length; i++) {
						if (me._ht_info_tooltip.userData.transitions[i].property == 'alpha') {
							clearInterval(me._ht_info_tooltip.userData.transitions[i].interval);
							me._ht_info_tooltip.userData.transitions.splice(i, 1);
							break;
						}
					}
					{
						...
						transition_alpha.property = 'alpha';
						transition_alpha.startTime = Date.now();
						transition_alpha.startAlpha = me._ht_info_tooltip.material ? me._ht_info_tooltip.material.opacity : me._ht_info_tooltip.userData.opacity;
						transition_alpha.interval = setInterval(() => {
							let currentTime = Date.now() - 0;
							let percentDone = 1.0 * (currentTime - transition_alpha.startTime) / 200;
							percentDone = Math.max(percentDone, 0.0);
							percentDone = Math.min(percentDone, 1.0);
							let tfval = -(Math.cos(Math.PI * percentDone) - 1) / 2;
							me._ht_info_tooltip.userData.setOpacity(transition_alpha.startAlpha + (me._ht_info_tooltip.userData.transitionValue_alpha - transition_alpha.startAlpha) * tfval);
							player.repaint();
							if (percentDone >= 1.0) {
								clearInterval(transition_alpha.interval);
								me._ht_info_tooltip.userData.transitions.splice(me._ht_info_tooltip.userData.transitions.indexOf(transition_alpha), 1);
							}
						}, 20);
						me._ht_info_tooltip.userData.transitions.push(transition_alpha);
					}
				}
				else {
					me._ht_info_tooltip.userData.transitionValue_alpha = 0;
					for (var i = 0; i < me._ht_info_tooltip.userData.transitions.length; i++) {
						if (me._ht_info_tooltip.userData.transitions[i].property == 'alpha') {
							clearInterval(me._ht_info_tooltip.userData.transitions[i].interval);
							me._ht_info_tooltip.userData.transitions.splice(i, 1);
		...
		me._ht_info.add(me._ht_info_tooltip);
		el = new THREE.Mesh();
		el.translateX(0);
		el.translateY(0);
		el.scale.set(1.00, 1.00, 1.0);
		...
		me._ht_info_icon = el;
		el.userData.setOpacityInternal = function(v) {
			if (me._ht_info_icon.userData.materialNormal) me._ht_info_icon.userData.materialNormal.opacity = v;
			if (me._ht_info_icon.userData.materialOver) me._ht_info_icon.userData.materialOver.opacity = v;
			if (me._ht_info_icon.userData.materialActive) me._ht_info_icon.userData.materialActive.opacity = v;
			me._ht_info_icon.visible = (v>0 && me._ht_info_icon.userData.visible);
		}
		loader = new THREE.TextureLoader();
		texture = loader.load('data:image/png;base64,'+
	''+
	''+
	''+
	''+
	''+
	''+
	'CC');
		texture.colorSpace = player.getTextureColorSpace();
		material = new THREE.MeshBasicMaterial( {map: texture, side: THREE.DoubleSide, transparent: true} );
		...
		el.userData.materialNormal = material;
		el.userData.materialCurrent = material;
		textureOver = loader.load('data:image/png;base64,'+
	''+
	''+
	''+
	''+
	''+
	''+
	'ykDpHRuDDtLY7Yj5sMILL7oGselQ5y5fM4dkRyc5Zf38HoXwBZ/jzOOuuss042+S/6rFMAbk37OQAAAABJRU5ErkJggg==');
		textureOver.colorSpace = player.getTextureColorSpace();
		el.userData.materialOver = new THREE.MeshBasicMaterial( {map: textureOver, side: THREE.DoubleSide, transparent: true} );
		el.userData.materialOver.name = 'ht_info_icon_materialOver';
		el.userData.createGeometry = function(brTopLeft, brTopRight, brBottomRight, brBottomLeft) {
			let el = me._ht_info_icon;
			skin.disposeGeometryAndMaterial(el);
			skin.removeChildren(el, 'subElement');
			let minDim = Math.min(el.userData.width, el.userData.height) / 2;
			el.userData.borderRadiusInnerShape.topLeft = Math.min(brTopLeft, minDim);
			...
			el.userData.borderRadiusInnerShape.bottomRight = Math.min(brBottomRight, minDim);
			el.userData.borderRadiusInnerShape.bottomLeft = Math.min(brBottomLeft, minDim);
		geometry = new THREE.PlaneGeometry(me._ht_info_icon.userData.width / 100.0, me._ht_info_icon.userData.height / 100.0, 5, 5 );
		...
		me._ht_info_icon.logicBlock_alpha = function() {
			...
			if (me._ht_info_icon.ggCurrentLogicStateAlpha != newLogicStateAlpha) {
				...
				if (me._ht_info_icon.ggCurrentLogicStateAlpha == 0) {
					me._ht_info_icon.userData.transitionValue_alpha = 0;
					for (var i = 0; i < me._ht_info_icon.userData.transitions.length; i++) {
						if (me._ht_info_icon.userData.transitions[i].property == 'alpha') {
					...
					}
					{
						...
						transition_alpha.property = 'alpha';
						transition_alpha.startTime = Date.now();
						transition_alpha.startAlpha = me._ht_info_icon.material ? me._ht_info_icon.material.opacity : me._ht_info_icon.userData.opacity;
						transition_alpha.interval = setInterval(() => {
							let currentTime = Date.now() - 0;
							let percentDone = 1.0 * (currentTime - transition_alpha.startTime) / 300;
							percentDone = Math.max(percentDone, 0.0);
							percentDone = Math.min(percentDone, 1.0);
							let tfval = -(Math.cos(Math.PI * percentDone) - 1) / 2;
							me._ht_info_icon.userData.setOpacity(transition_alpha.startAlpha + (me._ht_info_icon.userData.transitionValue_alpha - transition_alpha.startAlpha) * tfval);
							player.repaint();
							if (percentDone >= 1.0) {
								clearInterval(transition_alpha.interval);
								me._ht_info_icon.userData.transitions.splice(me._ht_info_icon.userData.transitions.indexOf(transition_alpha), 1);
							}
						}, 20);
						me._ht_info_icon.userData.transitions.push(transition_alpha);
					}
				}
				else {
					me._ht_info_icon.userData.transitionValue_alpha = 1;
					for (var i = 0; i < me._ht_info_icon.userData.transitions.length; i++) {
						if (me._ht_info_icon.userData.transitions[i].property == 'alpha') {
							clearInterval(me._ht_info_icon.userData.transitions[i].interval);
							me._ht_info_icon.userData.transitions.splice(i, 1);
		...
		me._ht_info_icon.logicBlock_zindex = function() {
			var newLogicStateZIndex;
			if (
				((me.elementMouseOver['ht_info'] == true)) && 
				((player.is3dModel() == true))
			...
			if (me._ht_info_icon.ggCurrentLogicStateZIndex != newLogicStateZIndex) {
				me._ht_info_icon.ggCurrentLogicStateZIndex = newLogicStateZIndex;
				if (me._ht_info_icon.ggCurrentLogicStateZIndex == 0) {
					me._ht_info_icon.userData.zIndexCurrent = 1;
			me._ht_info_icon.traverse((obj)=>{
				let level = skin.getDepthFrom(me._ht_info_icon, obj);
				let treePos = obj.parent ? obj.parent.children.indexOf(obj) : 0;
				if (1 > 0) {
					if (obj == me._ht_info_icon) {
						obj.renderOrder = 10000 + 1000*1
					} else {
						let parentOrder = obj.parent.renderOrder;
						let isSkinElement = obj.userData.hasOwnProperty('ggId');
					...
					obj.renderOrder = me._ht_info_icon.userData.renderOrder + level;
				}
				if (obj.material) {
					if (player.get3dModelType() != 2) {
						obj.material.depthTest = false;
			...
			player.repaint();
					...
					me._ht_info_icon.userData.zIndexCurrent = -10000;
			me._ht_info_icon.traverse((obj)=>{
				let level = skin.getDepthFrom(me._ht_info_icon, obj);
				let treePos = obj.parent ? obj.parent.children.indexOf(obj) : 0;
				if (-10000 > 0) {
			...
			if (
				...
				}
				{
					...
					transition_alpha.interval = setInterval(() => {
						...
						percentDone = Math.min(percentDone, 1.0);
						let tfval = Math.sin((percentDone * Math.PI) / 2);
						me._ht_info_popup_text.userData.setOpacity(transition_alpha.startAlpha + (me._ht_info_icon.userData.transitionValue_alpha - transition_alpha.startAlpha) * tfval);
						player.repaint();
						if (percentDone >= 1.0) {
							clearInterval(transition_alpha.interval);
							me._ht_info_popup_text.userData.transitions.splice(me._ht_info_popup_text.userData.transitions.indexOf(transition_alpha), 1);
		...
		me._ht_info_icon.userData.onmouseenter=function (e) {
			player.setOverrideCursor('pointer');
			me._ht_info_icon.material = me._ht_info_icon.userData.materialCurrent = me._ht_info_icon.userData.materialOver;
			me.elementMouseOver['ht_info_icon']=true;
		}
		me._ht_info_icon.userData.onmouseleave=function (e) {
			player.setOverrideCursor('default');
			me._ht_info_icon.material = me._ht_info_icon.userData.materialCurrent = me._ht_info_icon.userData.materialNormal;
		...
		me._ht_info_popup_3d.traverse((obj)=>{
			let level = skin.getDepthFrom(me._ht_info_popup_3d, obj);
			let treePos = obj.parent ? obj.parent.children.indexOf(obj) : 0;
			if (1 > 0) {
				if (obj == me._ht_info_popup_3d) {
					obj.renderOrder = 10000 + 1000*1
				} else {
					let parentOrder = obj.parent.renderOrder;
					let isSkinElement = obj.userData.hasOwnProperty('ggId');
				...
				obj.renderOrder = me._ht_info_popup_3d.userData.renderOrder + level;
			}
			if (obj.material) {
				if (player.get3dModelType() != 2) {
					obj.material.depthTest = false;
		...
		player.repaint();
		me._ht_info_popup_3d.userData.setOpacity(1.00);
		me._ht_info_popup_3d.logicBlock_visible();
		me._ht_info_popup_text_3d.userData.setOpacity(1.00);
		me._ht_info_popup_text_body_3d.userData.setOpacity(1.00);
			me._ht_info_popup_text_body_3d.userData.ggUpdateText(true);
		me._ht_info_popup_text_headline_3d.userData.setOpacity(1.00);
			me._ht_info_popup_text_headline_3d.userData.ggUpdateText(true);
		me._ht_info_popup.userData.setOpacity(0.00);
		me._ht_info_popup.logicBlock_size();
		me._ht_info_popup.logicBlock_alpha();
		me._ht_info_popup_text.userData.setOpacity(0.00);
		me._ht_info_popup_text_body.userData.setOpacity(1.00);
			me._ht_info_popup_text_body.userData.ggUpdateText(true);
		me._ht_info_popup_text_headline.userData.setOpacity(1.00);
			me._ht_info_popup_text_headline.userData.ggUpdateText(true);
		me._ht_info_popup_close.userData.setOpacity(0.00);
		me.elementMouseOver['ht_info_popup_close']=false;
		me._ht_info_popup_close.logicBlock_alpha();
		me._ht_info_popup_close.logicBlock_zindex();
		me._ht_info_tooltip.userData.setOpacity(0.00);
			me._ht_info_tooltip.userData.ggUpdateText(true);
		me._ht_info_tooltip.logicBlock_alpha();
		...
		me._ht_info_icon.logicBlock_zindex();
			me.ggEvent_changenode=function() {
				me._ht_info.logicBlock_visible();
				me._ht_info_popup_3d.logicBlock_visible();
					me._ht_info_popup_text_body_3d.userData.ggUpdateText();
					me._ht_info_popup_text_headline_3d.userData.ggUpdateText();
				me._ht_info_popup.logicBlock_size();
				me._ht_info_popup.logicBlock_alpha();
					me._ht_info_popup_text_body.userData.ggUpdateText();
					me._ht_info_popup_text_headline.userData.ggUpdateText();
				me._ht_info_popup_close.logicBlock_alpha();
				me._ht_info_popup_close.logicBlock_zindex();
	...
	function SkinHotspotClass_ht_info(parentScope,hotspot) {
		...
		el=me._ht_info_popup_3d=document.createElement('div');
		el.ggId="ht_info_popup_3d";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1,def:'' };
		el.ggVisible=false;
		el.className="ggskin ggskin_rectangle ";
		el.ggType='rectangle';
		...
		el.setAttribute('style',hs);
		el.style.transformOrigin='50% 50%';
		me._ht_info_popup_3d.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		...
		me._ht_info_popup_3d.logicBlock_visible = function() {
			...
			if (me._ht_info_popup_3d.ggCurrentLogicStateVisible != newLogicStateVisible) {
				me._ht_info_popup_3d.ggCurrentLogicStateVisible = newLogicStateVisible;
				me._ht_info_popup_3d.style.transition='';
				if (me._ht_info_popup_3d.ggCurrentLogicStateVisible == 0) {
					me._ht_info_popup_3d.style.visibility=(Number(me._ht_info_popup_3d.style.opacity)>0||!me._ht_info_popup_3d.style.opacity)?'inherit':'hidden';
					me._ht_info_popup_3d.ggVisible=true;
				}
				else {
					me._ht_info_popup_3d.style.visibility="hidden";
					me._ht_info_popup_3d.ggVisible=false;
				}
			}
		}
		me._ht_info_popup_3d.ggUpdatePosition=function (useTransition) {
		}
		el=me._ht_info_popup_text_3d=document.createElement('div');
		el.ggId="ht_info_popup_text_3d";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1,def:'' };
		el.ggVisible=true;
		el.className="ggskin ggskin_container ";
		el.ggType='container';
		...
		el.setAttribute('style',hs);
		el.style.transformOrigin='50% 50%';
		me._ht_info_popup_text_3d.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		...
		me._ht_info_popup_text_3d.ggUpdatePosition=function (useTransition) {
		}
		el=me._ht_info_popup_text_body_3d=document.createElement('div');
		els=me._ht_info_popup_text_body_3d__text=document.createElement('div');
		el.className='ggskin ggskin_textdiv';
		el.ggTextDiv=els;
		el.ggId="ht_info_popup_text_body_3d";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1,def:'' };
		el.ggVisible=true;
		el.className="ggskin ggskin_text noto_sans";
		el.ggType='text';
		...
		hs+='overflow-y: auto;';
		els.setAttribute('style',hs);
		me._ht_info_popup_text_body_3d.ggUpdateText=function() {
			var params = [];
			params.push(String(player._(me.hotspot.description)));
			var hs = player._("%1", params);
			if (hs!=this.ggText) {
		...
		me._ht_info_popup_text_body_3d.ggUpdateText();
		player.addListener('changenode', function() {
			me._ht_info_popup_text_body_3d.ggUpdateText();
		});
		el.appendChild(els);
		me._ht_info_popup_text_body_3d.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		...
		me._ht_info_popup_text_body_3d.ggUpdatePosition=function (useTransition) {
		}
		me._ht_info_popup_text_3d.appendChild(me._ht_info_popup_text_body_3d);
		el=me._ht_info_popup_text_headline_3d=document.createElement('div');
		els=me._ht_info_popup_text_headline_3d__text=document.createElement('div');
		el.className='ggskin ggskin_textdiv';
		el.ggTextDiv=els;
		el.ggId="ht_info_popup_text_headline_3d";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1,def:'' };
		el.ggVisible=true;
		el.className="ggskin ggskin_text varela";
		el.ggType='text';
		...
		hs+='text-overflow: ellipsis;';
		els.setAttribute('style',hs);
		me._ht_info_popup_text_headline_3d.ggUpdateText=function() {
			var params = [];
			params.push(String(player._(me.hotspot.title)));
			var hs = player._("%1", params);
			if (hs!=this.ggText) {
		...
		me._ht_info_popup_text_headline_3d.ggUpdateText();
		player.addListener('changenode', function() {
			me._ht_info_popup_text_headline_3d.ggUpdateText();
		});
		el.appendChild(els);
		me._ht_info_popup_text_headline_3d.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		...
		me._ht_info_popup_text_headline_3d.ggUpdatePosition=function (useTransition) {
		}
		me._ht_info_popup_text_3d.appendChild(me._ht_info_popup_text_headline_3d);
		me._ht_info_popup_3d.appendChild(me._ht_info_popup_text_3d);
		me._ht_info.appendChild(me._ht_info_popup_3d);
		...
		me._ht_info_popup_close.logicBlock_zindex = function() {
			...
			if (me._ht_info_popup_close.ggCurrentLogicStateZIndex != newLogicStateZIndex) {
				...
				me._ht_info_popup_close.style.transition='opacity 300ms ease 0ms';
				if (me._ht_info_popup_close.ggCurrentLogicStateZIndex == 0) {
					me._ht_info_popup_close.style.zIndex = 1;
				}
				else {
					me._ht_info_popup_close.style.zIndex = 'auto';
				}
			}
		}
		...
		me._ht_info_icon.logicBlock_zindex = function() {
			...
			if (me._ht_info_icon.ggCurrentLogicStateZIndex != newLogicStateZIndex) {
				...
				me._ht_info_icon.style.transition='opacity 300ms ease 0ms';
				if (me._ht_info_icon.ggCurrentLogicStateZIndex == 0) {
					me._ht_info_icon.style.zIndex = 1;
				}
				else {
					me._ht_info_icon.style.zIndex = 'auto';
				}
			}
		}
